          ...
          <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img
                ...
                src="https://hasanshahriar32.github.io/project/module15/project1/images/team/loki-funko-2.png"
                alt="Bonnie Avatar"
              />
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img
                class="mx-auto mb-4 w-36 h-36 rounded-full"
                src="https://hasanshahriar32.github.io/project/module15/project1/images/team/honu.png"
                alt="Helene Avatar"
              />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Kajol</a>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img
                class="mx-auto mb-4 w-36 h-36 rounded-full"
                src="https://hasanshahriar32.github.io/project/module15/project1/images/team/pod.png"
                alt="Jese Avatar"
              />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Fuad</a>
