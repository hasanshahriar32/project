...
const Orders = () => {
  ...
  useEffect(() => {
    fetch(
      ` https://b612-used-products-resale-server-side-hasanshahriar32.vercel.app/orders?UserId=${user?.uid}`,
      {
        method: "GET",
        headers: {
  ...
  const handleDelete = (id) => {
    fetch(
      ` https://b612-used-products-resale-server-side-hasanshahriar32.vercel.app/deleteOrder/${id}`,
      {
        method: "DELETE",
        cors: "no-cors",
      }
