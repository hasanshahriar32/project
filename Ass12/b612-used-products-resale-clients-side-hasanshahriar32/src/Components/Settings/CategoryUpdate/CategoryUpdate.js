...
const CategoryUpdate = () => {
  ...
  const deleteHandle = (id) => {
    fetch(
      ` https://b612-used-products-resale-server-side-hasanshahriar32.vercel.app/deleteCategory/${id}`,
      {
        method: "DELETE",
      }
    )
  ...
  const handleUpdate = (e) => {
    ...
    fetch(
      ` https://b612-used-products-resale-server-side-hasanshahriar32.vercel.app/categoryUpdate/${data._id}`,
      {
        method: "PUT",
        headers: {
