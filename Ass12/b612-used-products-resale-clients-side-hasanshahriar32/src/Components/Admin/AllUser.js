...
const AllUser = () => {
  ...
  //   axios
  //     .get(
  //       " https://b612-used-products-resale-server-side-hasanshahriar32.vercel.app/users"
  //     )
  //     .then((res) => {
  //       setUsers(res.data);
  //     })
  ...
  const { data: users = [], refetch } = useQuery({
    queryKey: ["users"],
    queryFn: () =>
      axios.get("https://b612-used-products-resale-server-side-hasanshahriar32.vercel.app/users").then((res) => res.data),
  });

  const handleRemoveUser = (id) => {
    fetch(`https://b612-used-products-resale-server-side-hasanshahriar32.vercel.app/admin/deleteUser/${id}`, {
      method: "DELETE",
      headers: {
  ...
  const handleMakeAdmin = (id) => {
    ...
    fetch(`https://b612-used-products-resale-server-side-hasanshahriar32.vercel.app/users/admin/${id}`, {
      method: "PUT",
      headers: {
        authorization: `bearer ${localStorage.getItem("token")}`,
      },
