...
function L(t) {
    ...
    if (O.logLevel <= h.DEBUG) {
        var i = e.map(F);
        O.debug.apply(O, r([ "Firestore (" + k + "): " + t ], i));
    }
}
...
function M(t) {
    ...
    if (O.logLevel <= h.ERROR) {
        var i = e.map(F);
        O.error.apply(O, r([ "Firestore (" + k + "): " + t ], i));
    }
}
 ...
 */ function P(t) {
    ...
    if (O.logLevel <= h.WARN) {
        var i = e.map(F);
        O.warn.apply(O, r([ "Firestore (" + k + "): " + t ], i));
    }
}
 ...
 */ function q(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (" + k + ") INTERNAL ASSERTION FAILED: " + t;
 ...
 */ var K = {
    ...
    return t.prototype.start = function(t, r) {
        ...
        this.o = function() {
            i.i++, i.currentUser = i.u(), s.resolve(), s = new Q, t.enqueueRetryable((function() {
        ...
        setTimeout((function() {
            if (!i.auth) {
                ...
                L("FirebaseAuthCredentialsProvider", "Auth not yet detected"), s.resolve(), s = new Q);
            }
        }), 0), a();
    ...
    return t.prototype.start = function(t, e) {
        var n = this, r = function(t) {
            null != t.error && L("FirebaseAppCheckTokenProvider", "Error getting App Check token; using placeholder token instead. Error: " + t.error.message);
            var r = t.token !== n.A;
            return n.A = t.token, L("FirebaseAppCheckTokenProvider", "Received " + (r ? "new" : "existing") + " token."), 
        ...
        return this.forceRefresh = !1, this.appCheck ? this.appCheck.getToken(e).then((function(e) {
            return e ? (U("string" == typeof e.token), t.A = e.token, new J(e.token)) : null;
        })) : Promise.resolve(null);
    }, t.prototype.invalidateToken = function() {
        this.forceRefresh = !0;
    }, t.prototype.shutdown = function() {
 ...
 */ var ut = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var u = o[i];
            if (u.indexOf("//") >= 0) throw new j(K.INVALID_ARGUMENT, "Invalid segment (" + u + "). Paths must not contain // in them.");
...
}(at), lt = /^[_a-zA-Z][_a-zA-Z0-9]*$/, ht = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new j(K.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, u = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                ...
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new j(K.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var St = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Dt = /** @class */ function() {
    function t() {
 ...
 */ var xt = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.P = new Q, this.transaction.oncomplete = function() {
            n.P.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.P.reject(new kt(t, e.error)) : n.P.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Mt(e.target.error);
            n.P.reject(new kt(t, r));
        };
    }
    return t.open = function(e, n, r, i) {
        ...
        t && this.P.reject(t), this.aborted || (L("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 4:
                                ...
                                return l = n.sent(), f = "FirebaseError" !== (h = l).name && u < 3, L("SimpleDb", "Transaction failed with error:", h.message, "Retrying:", f), 
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, K.UNAVAILABLE, "IndexedDB transaction '" + t + "' failed: " + n) || this).name = "IndexedDbTransactionError", 
        r;
    }
    return t(n, e), n;
}(j);
...
/** This class is responsible for the scheduling of Index Backfiller. */ var Pt = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.start = function() {
        ...
        var r = this;
        L("IndexBackiller", "Scheduled in " + t + "ms"), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill" /* IndexBackfill */ , t, (function() {
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return n.trys.push([ 1, 3, , 7 ]), t = L, e = [ "IndexBackiller" ], r = "Documents written: ", 
                        [ 4 /*yield*/ , this.et.st() ];
                      ...
                      case 3:
                        return Ot(i = n.sent()) ? (L("IndexBackiller", "Ignoring IndexedDB error during index backfill: ", i), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    /** Writes index entries until the cap is reached. Returns the number of documents processed. */ t.prototype.it = function(t, e) {
        ...
        return xt.doWhile((function() {
            ...
            return n.localStore.indexManager.getNextCollectionGroupToUpdate(t).next((function(e) {
                if (null !== e && !r.has(e)) return L("IndexBackiller", "Processing collection: " + e), 
        ...
        // Use the earliest offset of all field indexes to query the local cache.
            ...
            return r.localStore.localDocuments.getNextDocuments(t, e, i, n).next((function(n) {
                ...
                return r.localStore.indexManager.updateIndexEntries(t, o).next((function() {
                    ...
                    return L("IndexBackiller", "Updating offset: " + n), r.localStore.indexManager.updateCollectionGroup(t, e, n);
                })).next((function() {
                    return o.size;
                }));
            }));
...
var Kt = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, Qt.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, Qt.BLACK, null, null));
    }, 
...
var zt = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.firstAfterOrEqual = function(t) {
        ...
        return new Wt(this.data.getIteratorFrom(t));
    }, 
 ...
 */ var Yt = /** @class */ function() {
    ...
    t.prototype.unionWith = function(e) {
        for (var n = new zt(ht.comparator), r = 0, i = this.fields; r < i.length; r++) {
            var o = i[r];
            n = n.add(o);
        }
...
/** True if and only if the Base64 conversion functions are available. */ function Xt() {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return n === r ? ae(n) === ae(r) : isNaN(n) && isNaN(r);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return it(t.arrayValue.values || [], e.arrayValue.values || [], de);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (Ut(n) !== Ut(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !de(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function ve(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = rt(te(t.latitude), te(e.latitude));
            return 0 !== n ? n : rt(te(t.longitude), te(e.longitude));
...
function ye(t, e) {
    ...
    var n = $t(t), r = $t(e), i = rt(n.seconds, r.seconds);
...
/** Creates a deep copy of `source`. */ function De(t) {
    ...
    if (t.mapValue) {
        ...
        return Bt(t.mapValue.fields, (function(t, n) {
            return e.mapValue.fields[t] = De(n);
        })), e;
    }
    if (t.arrayValue) {
        for (var n = {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = De(t.arrayValue.values[r]);
        return n;
    }
...
/** Returns the lowest value for the given value type (inclusive). */ function xe(t) {
    return "nullValue" in t ? he : "booleanValue" in t ? {
        ...
        bytesValue: ""
    } : "referenceValue" in t ? we(ue.empty(), ft.empty()) : "geoPointValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
...
/** Returns the largest value for the given value type (exclusive). */ function Ne(t) {
    return "nullValue" in t ? {
        ...
        bytesValue: ""
    } : "bytesValue" in t ? we(ue.empty(), ft.empty()) : "referenceValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
 ...
 */ var ke = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!Se(e = (e.mapValue.fields || {})[t.get(n)])) return null;
    ...
    t.prototype.set = function(t, e) {
        this.getFieldsMap(t.popLast())[t.lastSegment()] = De(e);
    }, 
    /**
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = De(t) : i.push(o.lastSegment());
        }));
    ...
    t.prototype.delete = function(t) {
        ...
        Se(e) && e.mapValue.fields && delete e.mapValue.fields[t.lastSegment()];
    }, t.prototype.isEqual = function(t) {
        return de(this.value, t.value);
    }, 
    /**
...
var Re = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , st.min(), st.min(), ke.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newFoundDocument = function(e, n, r) {
        return new t(e, 1 /* FOUND_DOCUMENT */ , n, st.min(), r, 0 /* SYNCED */);
    }, 
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, st.min(), ke.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, st.min(), ke.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
function Me(t) {
    ...
    if (null === e.ht) {
        ...
        })).join(","), se(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
...
function Pe(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!$e(t.orderBy[n], e.orderBy[n])) return !1;
    if (t.filters.length !== e.filters.length) return !1;
    for (var r = 0; r < t.filters.length; r++) if (i = t.filters[r], o = e.filters[r], 
    i.op !== o.op || !i.field.isEqual(o.field) || !de(i.value, o.value)) return !1;
    var i, o;
...
/** Returns the field filters that target the given field path. */ function qe(t, e) {
    return t.filters.filter((function(t) {
        return t instanceof Ge && t.field.isEqual(e);
    }));
}
 ...
 */ function Ue(t, e, n) {
    ...
    for (var r = he, i = !0, o = 0, u = qe(t, e); o < u.length; o++) {
        var s = u[o], a = he, c = !0;
        switch (s.op) {
          case "<" /* LESS_THAN */ :
 ...
 */ function Be(t, e, n) {
    // Process all filters to find a value for the current field segment
    for (var r = le, i = !0, o = 0, u = qe(t, e); o < u.length; o++) {
        var s = u[o], a = le, c = !0;
        switch (s.op) {
          case ">=" /* GREATER_THAN_OR_EQUAL */ :
          case ">" /* GREATER_THAN */ :
...
/** Returns the number of segments of a perfect index for this target. */ var Ge = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.lt(t, e, r) : new Ke(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new We(t, r) : "in" /* IN */ === e ? new He(t, r) : "not-in" /* NOT_IN */ === e ? new Ye(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Xe(t, r) : new n(t, e, r);
    }, n.lt = function(t, e, n) {
        return "in" /* IN */ === e ? new je(t, n) : new Qe(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.ft(ve(e, this.value)) : null !== e && fe(this.value) === fe(e) && this.ft(ve(e, this.value));
...
/** A Filter that implements the array-contains operator. */ var We = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return Ie(e) && pe(e.arrayValue, this.value);
    }, n;
}(Ge), He = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "in" /* IN */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return null !== e && pe(this.value.arrayValue, e);
    }, n;
}(Ge), Ye = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "not-in" /* NOT_IN */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        if (pe(this.value.arrayValue, {
            nullValue: "NULL_VALUE"
        })) return !1;
        var e = t.data.field(this.field);
        return null !== e && !pe(this.value.arrayValue, e);
    }, n;
}(Ge), Xe = /** @class */ function(e) {
    function n(t, n) {
    ...
    return t(n, e), n.prototype.matches = function(t) {
        ...
        return !(!Ie(n) || !n.arrayValue.values) && n.arrayValue.values.some((function(t) {
            return pe(e.value.arrayValue, t);
        }));
    }, n;
}(Ge), Ze = function(t, e) {
    this.position = t, this.inclusive = e;
}, Je = function(t, e /* ASCENDING */) {
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

/** A Filter that implements the IN operator. */ function $e(t, e) {
...
function tn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? ft.comparator(ft.fromName(u.referenceValue), n.key) : ve(u, n.data.field(o.field)), 
 ...
 */ function en(t, e) {
    ...
    for (var n = 0; n < t.position.length; n++) if (!de(t.position[n], e.position[n])) return !1;
    return !0;
}
...
/** Creates a new Query instance with the options provided. */ function rn(t, e, n, r, i, o, u, s) {
    return new nn(t, e, n, r, i, o, u, s);
}
 ...
 */ function ln(t) {
    ...
    if (null === e._t) {
        ...
        n.isKeyField() || e._t.push(new Je(n)), e._t.push(new Je(ht.keyField(), "asc" /* ASCENDING */)); else {
            ...
            if (!i) {
                ...
                e._t.push(new Je(ht.keyField(), a));
            }
        }
    }
    return e._t;
 ...
 */ function hn(t) {
    var e = G(t);
    if (!e.wt) if ("F" /* First */ === e.limitType) e.wt = Le(e.path, e.collectionGroup, ln(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = ln(e); r < i.length; r++) {
            var o = i[r], u = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Je(o.field, u));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var s = e.endAt ? new Ze(e.endAt.position, e.endAt.inclusive) : null, a = e.startAt ? new Ze(e.startAt.position, e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
                e.wt = Le(e.path, e.collectionGroup, n, e.filters, e.limit, s, a);
    }
    return e.wt;
}
...
function dn(t, e) {
    return Pe(hn(t), hn(e)) && t.limitType === e.limitType;
}
...
function vn(t) {
    return "Query(target=" + function(t) {
        ...
        se(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return function(t) {
                return t.field.canonicalString() + " (" + t.dir + ")";
            }(t);
 ...
 */
        ...
        }(t.startAt, ln(t), e)) && !(t.endAt && !function(t, e, n) {
            var r = tn(t, e, n);
            return t.inclusive ? r >= 0 : r > 0;
        }(t.endAt, ln(t), e));
    }(t, e);
...
/** Transforms an array value via a remove operation. */ var Cn = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Ln = function(t, e) {
 ...
 */
/** Returns true if the preconditions is valid for the given document. */ function Fn(t, e) {
 ...
 */ function Un(t, e) {
    ...
    // mask is null when sets or deletes are applied to the current document.
        if (null === e) return t.isNoDocument() ? new Jn(t.key, Pn.none()) : new Qn(t.key, t.data, Pn.none());
    for (var n = t.data, r = ke.empty(), i = new zt(ht.comparator), o = 0, u = e.fields; o < u.length; o++) {
        var s = u[o];
        if (!i.has(s)) {
            var a = n.field(s);
    ...
    return new zn(t.key, r, new Yt(i.toArray()), Pn.none());
}
 ...
 */ function Bn(t, e, n) {
    t instanceof Qn ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = Hn(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof zn ? function(t, e, n) {
        if (Fn(t.precondition, e)) {
            var r = Hn(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(Wn(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Gn(t, e, n, r) {
    return t instanceof Qn ? function(t, e, n, r) {
        if (!Fn(t.precondition, e)) 
        // The mutation failed to apply (e.g. a document ID created with add()
        // caused a name collision).
        return n;
        var i = t.value.clone(), o = Yn(t.fieldTransforms, r, e);
        ...
        if (!Fn(t.precondition, e)) return n;
        var i = Yn(t.fieldTransforms, r, e), o = e.data;
        return o.setAll(Wn(t)), o.setAll(i), e.convertToFoundDocument(e.version, o).setHasLocalMutations(), 
        null === n ? null : n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map((function(t) {
            return t.field;
        })));
    }(t, e, n, r) : function(t, e, n) {
        return Fn(t.precondition, e) ? (e.convertToNoDocument(e.version).setHasLocalMutations(), 
        null) : n;
    }(t, e, n);
}
 ...
 */ function Yn(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(u.field, Sn(s, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var Xn, Zn, Jn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (Zn = Xn || (Xn = {}))[Zn.OK = 0] = "OK", Zn[Zn.CANCELLED = 1] = "CANCELLED", 
...
var ur = new Kt(ft.comparator);

function sr() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = ur, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.insert(o.key, o);
    }
    return n;
...
var fr = new Kt(ft.comparator), dr = new zt(ft.comparator);
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.xt = function() {
        ...
        })), new gr(this.Pt, this.vt, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype.Nt = function() {
        this.Vt = !1, this.bt = Dr();
    ...
    t.prototype.te = function(t) {
        ...
        var i = new mr(t, n, this.Kt, this.Ut, r);
        return this.Ut = or(), this.qt = Sr(), this.Kt = new zt(rt), i;
    }, 
    /**
    ...
    t.prototype.jt = function(t, e, n) {
        if (this.Ht(t)) {
            ...
            r.Ot(e), this.qt = this.qt.insert(e, this.ne(e).delete(t)), n && (this.Ut = this.Ut.insert(e, n));
        }
...
function Or(t) {
    return U(!!t), st.fromTimestamp(function(t) {
        var e = $t(t);
        return new ut(e.seconds, e.nanos);
    }(t));
}
...
function Fr(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? ct.emptyPath() : Ur(e);
}
...
function Gr(t, e, n) {
    var r = Mr(t, e.name), i = Or(e.updateTime), o = new ke({
        mapValue: {
            fields: e.fields
        }
...
function Kr(t, e) {
    ...
    if (e instanceof Qn) n = {
        update: Br(t, e.key, e.value)
    }; else if (e instanceof Jn) n = {
        delete: Lr(t, e.key)
    }; else if (e instanceof zn) n = {
        update: Br(t, e.key, e.data),
        updateMask: ei(e.fieldMask)
    }; else {
        if (!(e instanceof $n)) return q();
        n = {
            verify: Lr(t, e.key)
        };
    }
...
function jr(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Pn.updateTime(Or(t.updateTime)) : void 0 !== t.exists ? Pn.exists(t.exists) : Pn.none();
        ...
        return function(t, e) {
            ...
            if ("setToServerValue" in e) U("REQUEST_TIME" === e.setToServerValue), n = new xn; else if ("appendMissingElements" in e) {
                ...
                n = new Cn(i);
            } else "increment" in e ? n = new On(t, e.increment) : q();
    ...
    if (e.update) {
        e.update.name;
        var i = Mr(t, e.update.name), o = new ke({
            mapValue: {
...
function zr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Pr(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Pr(t, r.popLast()), n.structuredQuery.from = [ {
...
function Wr(t) {
    var e = Fr(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        U(1 === r);
        var o = n.from[0];
    ...
    var u = [];
    n.where && (u = Hr(n.where));
    var s = [];
    n.orderBy && (s = n.orderBy.map((function(t) {
        return function(t) {
            return new Je(Jr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    n.limit && (a = function(t) {
        var e;
        return se(e = "object" == typeof t ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
    ...
    return n.endAt && (l = function(t) {
        var e = !t.before, n = t.values || [];
        return new Ze(n, e);
    }(n.endAt)), rn(e, i, s, u, a, "F" /* First */ , c, l);
}

function Hr(t) {
    return t ? void 0 !== t.unaryFilter ? [ ti(t) ] : void 0 !== t.fieldFilter ? [ $r(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Hr(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : q() : [];
...
function $r(t) {
    return Ge.create(Jr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function ti(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = Jr(t.unaryFilter.field);
        return Ge.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = Jr(t.unaryFilter.field);
        return Ge.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = Jr(t.unaryFilter.field);
        return Ge.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = Jr(t.unaryFilter.field);
 ...
 */ var Oi = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Bn(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t, e) {
        ...
        // to O(n).
            ...
            var o = t.get(i.key), u = o.overlayedDocument, s = n.applyToLocalView(u, o.mutatedFields), a = Un(u, 
            ...
            // and we should remove this cast.
                        null !== a && r.set(i.key, a), u.isValidDocument() || u.convertToNoDocument(st.min());
        })), r;
     ...
     * time from which the server should resume sending results.
     */ , u) {
        void 0 === i && (i = st.min()), void 0 === o && (o = st.min()), void 0 === u && (u = Zt.EMPTY_BYTE_STRING), 
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Bi(t, e) {
    ...
    var u = e.mutations.map((function(e) {
        return jr(t.re, e);
    })), s = ut.fromMillis(e.localWriteTimeMs);
    return new Oi(e.batchId, s, n, u);
}

/** Decodes a DbTarget into TargetData */ function Gi(t) {
    var e, n, r = Ui(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Ui(t.lastLimboFreeSnapshotVersion) : st.min();
    return void 0 !== t.query.documents ? (U(1 === (n = t.query).documents.length), 
    e = hn(on(Fr(n.documents[0])))) : e = function(t) {
        return hn(Wr(t));
    }(t.query), new Li(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, Zt.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Ki(t, e) {
    var n, r = qi(e.snapshotVersion), i = qi(e.lastLimboFreeSnapshotVersion);
    n = Fe(e.target) ? Qr(t.re, e.target) : zr(t.re, e.target);
...
function Wi(t, e, n, r) {
    return {
        ...
        uid: e.uid || "",
        sequenceNumber: n,
        readTime: qi(r.readTime),
        documentKey: ri(r.documentKey.path),
 ...
 */ var Zi = /** @class */ function() {
    ...
    return t.oe = function(e, n) {
        ...
        var n = this;
        return Ji(t).get(zi(this.userId, e)).next((function(t) {
            return t ? Qi(n.It, t) : null;
        }));
        ...
        e.forEach((function(t) {
            return i.add(ri(t.getCollectionPath()));
        }));
        var o = [];
        ...
        /*lowerOpen=*/ !0);
        return Ji(t).W("collectionPathOverlayIndex", u).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) {
                var o = n[e], u = Qi(r.It, o);
                i.set(u.getKey(), u);
            }
            return i;
        }));
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        var i, o = this, u = cr(), s = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Ji(t).Z({
        ...
        return Ji(t).put(function(t, e, n) {
            ...
            return r[0], {
                ...
                overlayMutation: Kr(t.re, n.mutation)
            };
...
/** Firestore index value writer.  */ var $i = /** @class */ function() {
    function t() {}
    ...
    /** Writes an index value.  */    return t.prototype.ce = function(t, e) {
        ...
        e.fe(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.le(e, 15), e.fe(te(t.integerValue)); else if ("doubleValue" in t) {
            var n = te(t.doubleValue);
        ...
        var n = this;
        this.le(e, 37), ft.fromName(t).path.forEach((function(t) {
            n.le(e, 60), n.Ie(t, e);
        }));
...
var no = /** @class */ function() {
    ...
    function t() {
        this.Be = new no, this.Le = new ro(this.Be), this.Ue = new io(this.Be);
    }
...
function so(t, e) {
    ...
    return 0 !== n ? n : 0 !== (n = ao(t.arrayValue, e.arrayValue)) ? n : 0 !== (n = ao(t.directionalValue, e.directionalValue)) ? n : ft.comparator(t.documentKey, e.documentKey);
}
 ...
 */ var co = /** @class */ function() {
     ...
     */    return t.prototype.We = function(t) {
        ...
        for (var n = vt(t), r = 0, i = 0; r < n.length && this.ze(n[r]); ++r) ;
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new zt(ct.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new zt(ct.comparator)).toArray();
    }, t;
}(), fo = new Uint8Array(0), po = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return vo(t).W(r).next((function(t) {
        ...
        var n = this, r = mo(t), i = function(t) {
            return {
                indexId: t.indexId,
        ...
        if (e.indexState) {
            ...
            return o.next((function(t) {
                u.put(Wi(t, n.user, e.indexState.sequenceNumber, e.indexState.offset));
            }));
        }
        return o.next();
    }, t.prototype.deleteFieldIndex = function(t, e) {
        var n = mo(t), r = go(t), i = yo(t);
        ...
        return xt.forEach(this.tn(e), (function(e) {
            ...
            if (i) {
                ...
                return xt.forEach(o, (function(i, o) {
                    ...
                    })).join(",") + " to execute ") + Me(e));
                    var a = function(t, e) {
                        var n = pt(e);
                        if (void 0 === n) return null;
                        for (var r = 0, i = qe(t, n.fieldPath); r < i.length; r++) {
                            var o = i[r];
                            switch (o.op) {
                        ...
                        for (var n = new Map, r = 0, i = vt(e); r < i.length; r++) for (var o = i[r], u = 0, s = qe(t, o.fieldPath); u < s.length; u++) {
                            var a = s[u];
                            switch (a.op) {
                              case "==" /* EQUAL */ :
                              case "in" /* IN */ :
                        ...
                        for (var n = [], r = !0, i = 0, o = vt(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? Ue(t, u.fieldPath, t.startAt) : Be(t, u.fieldPath, t.startAt);
                        ...
                        // endAt.
                        for (var n = [], r = !0, i = 0, o = vt(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? Be(t, u.fieldPath, t.endAt) : Ue(t, u.fieldPath, t.endAt);
                            n.push(s.value), r && (r = s.inclusive);
                        }
                        return new Ze(n, r);
    ...
    t.prototype.rn = function(t, e, n, r, i, o, u) {
        for (var s = this, a = (null != e ? e.length : 1) * Math.max(n.length, i.length), c = a / (null != e ? e.length : 1), l = [], h = function(a) {
            var h = e ? f.on(e[a / c]) : fo, d = f.un(t, h, n[a % c], r), p = f.cn(t, h, i[a % c], o), v = u.map((function(e) {
                return s.un(t, h, e, 
                /* inclusive= */ !0);
            }));
    ...
    /** Generates the upper bound for `arrayValue` and `directionalValue`. */ t.prototype.cn = function(t, e, n, r) {
        ...
        var n = new co(e), r = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment();
    ...
    t.prototype.an = function(t, e) {
        for (var n = new oo, r = 0, i = vt(t); r < i.length; r++) {
    ...
    /** Encodes a single value to the ascending index format. */ t.prototype.on = function(t) {
        var e = new oo;
        return $i.Te.ce(t, e.qe(0 /* ASCENDING */)), e.$e();
    }, 
    /**
    ...
    t.prototype.hn = function(t, e) {
        var n = new oo;
        return $i.Te.ce(we(this.databaseId, e), n.qe(function(t) {
            var e = vt(t);
    ...
    t.prototype.sn = function(t, e, n) {
        ...
        var r = [];
        r.push(new oo);
        for (var i = 0, o = 0, u = vt(t); o < u.length; o++) for (var s = u[o], a = n[i++], c = 0, l = r; c < l.length; c++) {
            var h = l[c];
            if (this.ln(e, s.fieldPath) && Ie(a)) r = this.fn(r, s, a); else {
                var f = h.qe(s.kind);
                $i.Te.ce(a, f);
            }
        }
    ...
    t.prototype.fn = function(t, e, n) {
        for (var i = r([], t), o = [], u = 0, s = n.arrayValue.values || []; u < s.length; u++) for (var a = s[u], c = 0, l = i; c < l.length; c++) {
            var h = l[c], f = new oo;
            f.seed(h.$e()), $i.Te.ce(a, f.qe(e.kind)), o.push(f);
        }
        return o;
    }, t.prototype.ln = function(t, e) {
        return !!t.filters.find((function(t) {
            return t instanceof Ge && t.field.isEqual(e) && ("in" /* IN */ === t.op || "not-in" /* NOT_IN */ === t.op);
        }));
    }, t.prototype.getFieldIndexes = function(t, e) {
        ...
        return yo(t).delete([ r.indexId, this.uid, r.arrayValue, r.directionalValue, this.hn(n, e.key), e.key.path.toArray() ]);
    }, t.prototype.wn = function(t, e, n) {
        var r = yo(t), i = new zt(so);
        return r.Z({
            index: "documentKeyIndex",
            range: IDBKeyRange.only([ n.indexId, this.uid, this.hn(n, e) ])
        }, (function(t, r) {
            i = i.add(new uo(n.indexId, e, r.arrayValue, r.directionalValue));
        })).next((function() {
            return i;
        }));
    }, 
    /** Creates the index entries for the given document. */ t.prototype.mn = function(t, e) {
        var n = new zt(so), r = this.an(e, t);
        if (null == r) return n;
        var i = pt(e);
        if (null != i) {
            var o = t.data.field(i.fieldPath);
            if (Ie(o)) for (var u = 0, s = o.arrayValue.values || []; u < s.length; u++) {
                var a = s[u];
                n = n.add(new uo(e.indexId, t.key, this.on(a), r));
            }
        } else n = n.add(new uo(e.indexId, t.key, fo, r));
        return n;
    }, 
    /**
    ...
    t.prototype.gn = function(t, e, n, r, i) {
        ...
        return function(t, e, n, r, i) {
            ...
            // `comparator`.
            for (var o = t.getIterator(), u = e.getIterator(), s = Ht(o), a = Ht(u); s || a; ) {
                var c = !1, l = !1;
                if (s && a) {
                    var h = n(s, a);
                    h < 0 ? 
                ...
                c ? (r(a), a = Ht(u)) : l ? (i(s), s = Ht(o)) : (s = Ht(o), a = Ht(u));
            }
        }(r, i, so, (
        /* onAdd= */ function(r) {
            u.push(o.yn(t, e, n, r));
    ...
    t.prototype.createRange = function(t, e, n) {
        ...
        r.push(e);
        for (var c = [], l = 0; l < r.length; l += 2) c.push(IDBKeyRange.bound([ r[l].indexId, this.uid, r[l].arrayValue, r[l].directionalValue, fo, [] ], [ r[l + 1].indexId, this.uid, r[l + 1].arrayValue, r[l + 1].directionalValue, fo, [] ]));
        return c;
    }, t.prototype.getMinOffsetFromCollectionGroup = function(t, e) {
 ...
 */
function vo(t) {
    return ki(t, "collectionParents");
}

/**
 * Helper to get a typed SimpleDbStore for the index entry object store.
 */ function yo(t) {
    return ki(t, "indexEntries");
}

/**
 * Helper to get a typed SimpleDbStore for the index configuration object store.
 */ function mo(t) {
    return ki(t, "indexConfiguration");
}

/**
 * Helper to get a typed SimpleDbStore for the index state object store.
 */ function go(t) {
    return ki(t, "indexState");
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ Io.DEFAULT_COLLECTION_PERCENTILE = 10, 
Io.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, Io.DEFAULT = new Io(41943040, Io.DEFAULT_COLLECTION_PERCENTILE, Io.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
Io.DISABLED = new Io(-1, 0, 0);
...
var So = /** @class */ function() {
    ...
    return t.oe = function(e, n, r, i) {
        ...
        return u.add({}).next((function(s) {
            U("number" == typeof s);
            for (var a = new Oi(s, e, n, r), c = function(t, e, n) {
                ...
                var p = d[f], v = ci(i.userId, p.key.path, s);
                h = h.add(p.key.path.popLast()), l.push(u.put(c)), l.push(o.put(v, li));
            }
    ...
    t.prototype.Tn = function(t, e) {
        ...
        return _o(t).Z({
            ...
            e.userId === n.userId && (U(e.batchId >= r), o = Bi(n.It, e)), i.done();
        })).next((function() {
            return o;
        }));
 ...
 */ var Ao = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            return ko(t).delete(e.targetId);
        })).next((function() {
            return n.Vn(t);
        })).next((function(e) {
            return U(e.targetCount > 0), e.targetCount -= 1, n.Sn(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.Cn = function(t, e) {
        ...
        var n = Me(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return ko(t).Z({
            range: r,
 ...
 */ var Lo = /** @class */ function() {
    ...
    return t.prototype.start = function() {
        ...
        var r = this;
        L("LruGarbageCollector", "Garbage collection scheduled in " + t + "ms"), this.Mn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , t, (function() {
            return e(r, void 0, void 0, (function() {
                var t;
                return n(this, (function(e) {
                    switch (e.label) {
                      case 0:
                        this.Mn = null, e.label = 1;
                      ...
                      case 3:
                        return Ot(t = e.sent()) ? (L("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return e > c.params.maximumSequenceNumbersToCollect ? (L("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + c.params.maximumSequenceNumbersToCollect + " from " + e), 
 ...
 */ var Uo = /** @class */ function() {
    function t() {
        ...
        this.changes = new rr((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
 ...
 */
    ...
    t.prototype.Hn = function(t, e) {
        ...
        return Qo(t).Z({
            ...
            for (var o = ft.fromSegments(r(r([], e.prefixPath), [ e.collectionGroup, e.documentId ])); s && Ho(s, o) < 0; ) n(s, null), 
            s = u.getNext();
            s && s.isEqual(o) && (
            // Key found in cache.
        ...
        var r = this, i = [ e.popLast().toArray(), e.lastSegment(), Fi(n.readTime), n.documentKey.path.isEmpty() ? "" : n.documentKey.path.lastSegment() ], o = [ e.popLast().toArray(), e.lastSegment(), [ Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER ], "" ];
        return Qo(t).W(IDBKeyRange.bound(i, o, !0)).next((function(t) {
            for (var e = or(), n = 0, i = t; n < i.length; n++) {
        ...
        return Qo(t).Z({
            ...
            var u = i.jn(ft.fromSegments(e.prefixPath.concat(e.collectionGroup, e.documentId)), e);
            (o = o.insert(u.key, u)).size === r && n.done();
        })).next((function() {
            return o;
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        return new Ko(this, !!t && t.trackRemovals);
    }, t.prototype.getSize = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return jo(t).get("remoteDocumentGlobalKey").next((function(t) {
            return U(!!t), t;
        }));
    }, t.prototype.Qn = function(t, e) {
        return jo(t).put("remoteDocumentGlobalKey", e);
    }, 
    /**
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, u) {
            ...
            if (n.push(e.Yn.removeEntry(t, o, s.readTime)), u.isValidDocument()) {
                ...
                var l = Pi(e.Yn.It, u.convertToNoDocument(st.min()));
...
function jo(t) {
    return ki(t, "remoteDocumentGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Qo(t) {
    return ki(t, "remoteDocumentsV14");
}
...
e) {
    ...
    return t.prototype.getDocument = function(t, e) {
        ...
        return this.documentOverlayCache.getOverlay(t, e).next((function(i) {
            ...
            return null !== r && Gn(r.mutation, t, Yt.empty(), ut.now()), t;
        }));
    }, 
    /**
    ...
    t.prototype.getDocuments = function(t, e) {
        ...
        return this.remoteDocumentCache.getEntries(t, e).next((function(e) {
            return n.getLocalViewOfDocuments(t, e, pr()).next((function() {
                return e;
            }));
        }));
    }, 
    ...
    t.prototype.getOverlayedDocuments = function(t, e) {
        ...
        return this.populateOverlays(t, r, e).next((function() {
            return n.computeViews(t, e, r, pr());
        }));
    }, 
    /**
    ...
    t.prototype.computeViews = function(t, e, n, r) {
        ...
        return e.forEach((function(t, e) {
            ...
            Gn(u.mutation, e, u.mutation.getFieldMask(), ut.now()));
        })), this.recalculateAndSaveOverlays(t, i).next((function(t) {
            return t.forEach((function(t, e) {
                return o.set(t, e);
            })), e.forEach((function(t, e) {
                var n;
                return u.set(t, new Yo(e, null !== (n = o.get(t)) && void 0 !== n ? n : null));
            })), u;
        }));
    }, t.prototype.recalculateAndSaveOverlays = function(t, e) {
        var n = this, r = hr(), i = new Kt((function(t, e) {
            return t - e;
        })), o = pr();
        return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t, e).next((function(t) {
            for (var n = function(t) {
                t.keys().forEach((function(n) {
                    var o = e.get(n);
                    if (null !== o) {
                        var u = r.get(n) || Yt.empty();
                        u = t.applyToLocalView(o, u), r.set(n, u);
                        var s = (i.get(t.batchId) || pr()).add(n);
            ...
            for (var u = [], s = i.getReverseIterator(), a = function() {
                var i = s.getNext(), a = i.key, c = i.value, l = lr();
                c.forEach((function(t) {
                    if (!o.has(t)) {
                        var n = Un(e.get(t), r.get(t));
 ...
 */
    ...
    t.prototype.getNextDocuments = function(t, e, n, r) {
        ...
        return this.remoteDocumentCache.getAllFromCollectionGroup(t, e, n, r).next((function(o) {
            ...
            // the batch id.
                ...
                return xt.forEach(e, (function(e, n) {
                    ...
                    return i.computeViews(t, a, e, pr());
                })).next((function(t) {
                    return {
                        batchId: s,
                        changes: ar(t)
        ...
        // Query the remote documents and overlay mutations.
            ...
            return r.forEach((function(r, i) {
                var o = t.get(r);
                void 0 !== o && Gn(o.mutation, i, Yt.empty(), ut.now()), 
                // Finally, insert the documents that still match the query
                yn(e, i) && (n = n.insert(r, i));
            })), n;
        }));
    }, 
    ...
    return t.prototype.getOverlay = function(t, e) {
        ...
        for (var i = new Kt((function(t, e) {
            ...
            if (u.getKey().getCollectionGroup() === e && u.largestBatchId > n) {
                ...
                null === s && (s = cr(), i = i.insert(u.largestBatchId, s)), s.set(u.getKey(), u);
            }
        }
    ...
    function t() {
        ...
        this.ns = new zt(tu.ss), 
        // A set of outstanding references to a document sorted by target id.
        this.rs = new zt(tu.os)
    ...
    t.prototype.ls = function(t) {
        var e = this, n = new ft(new ct([])), r = new tu(n, t), i = new tu(n, t + 1), o = [];
        ...
        var e = new ft(new ct([])), n = new tu(e, t), r = new tu(e, t + 1), i = pr();
        return this.rs.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new tu(t, 0), n = this.ns.firstAfterOrEqual(e);
    ...
    return t.ss = function(t, e) {
        return ft.comparator(t.key, e.key) || rt(t._s, e._s);
    }, 
    /** Compare by ID then by key */ t.os = function(t, e) {
        return rt(t._s, e._s) || ft.comparator(t.key, e.key);
    }, t;
}(), eu = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        return e.forEach((function(t) {
            var e = new tu(t, 0), i = new tu(t, Number.POSITIVE_INFINITY);
        ...
        var o = new tu(new ft(i), 0), u = new zt(rt);
    ...
    function t(t) {
        ...
        this.docs = new Kt(ft.comparator), 
...
}(Uo), iu = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Rs = new rr((function(t) {
            return Me(t);
        }), Pe), 
    ...
    function t(t, e) {
        var n = this;
        this.Vs = {}, this.overlays = {}, this.Ss = new qt(0), this.Ds = !1, this.Ds = !0, 
        this.referenceDelegate = t(this), this.Cs = new iu(this), this.indexManager = new lo, 
        this.remoteDocumentCache = new nu((function(t) {
            return n.referenceDelegate.xs(t);
        })), this.It = new Mi(e), this.Ns = new Zo(this.It);
    }
    return t.prototype.start = function() {
        ...
        return e || (e = new Jo, this.overlays[t.toKey()] = e), e;
    }, t.prototype.getMutationQueue = function(t, e) {
        var n = this.Vs[t.toKey()];
        return n || (n = new eu(e, this.referenceDelegate), this.Vs[t.toKey()] = n), n;
        ...
        var i = new uu(this.Ss.next());
        return this.referenceDelegate.ks(), n(i).next((function(t) {
            return r.referenceDelegate.Os(i).next((function() {
                return t;
            }));
     ...
     */    return t.prototype.$ = function(t, e, n, r) {
        ...
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore("mutationQueues", {
                ...
                keyPath: "batchId",
                autoIncrement: !0
            }).createIndex("userMutationsIndex", si, {
                unique: !0
     ...
     */
        ...
        u = u.next((function() {
            ...
            return function(t) {
                ...
                e.createIndex("documentKeyIndex", fi), e.createIndex("collectionGroupIndex", di);
            }(t);
        })).next((function() {
            return i.Ws(t, o);
        })).next((function() {
            ...
            return function(t) {
                t.createObjectStore("indexConfiguration", {
                    ...
                    keyPath: gi
                }).createIndex("sequenceNumberIndex", wi, {
                    unique: !1
                }), t.createObjectStore("indexEntries", {
                    keyPath: bi
                }).createIndex("documentKeyIndex", Ii, {
                    unique: !1
                });
            }(t);
        }))), u;
    ...
    t.prototype.Gs = function(t) {
        ...
        var n = e.store("collectionParents"), r = new ho, i = function(t) {
            if (r.add(t)) {
        ...
        return n.Z((function(t, r) {
            var i = Gi(r), o = Ki(e.It, i);
            return n.put(o);
        }));
    }, t.prototype.Ws = function(t, e) {
        var n = e.store("remoteDocuments"), r = [];
        return n.Z((function(t, n) {
            var i, o = e.store("remoteDocumentsV14"), u = (i = n, i.document ? new ft(ct.fromString(i.document.name).popFirst(5)) : i.noDocument ? ft.fromSegments(i.noDocument.path) : i.unknownDocument ? ft.fromSegments(i.unknownDocument.path) : q()).path.toArray(), s = {
        ...
        return r.W().next((function(t) {
            var r = new Map;
            return t.forEach((function(t) {
                var e, i = null !== (e = r.get(t.userId)) && void 0 !== e ? e : pr();
...
var lu = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", hu = /** @class */ function() {
    function t(
    /**
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new j(K.FAILED_PRECONDITION, lu);
    ...
    t.prototype.di = function(t) {
        ...
        return this.Ys ? xt.resolve(!0) : fu(t).get("owner").next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || du(t).W().next((function(t) {
    ...
    t.prototype.vi = function() {
        ...
        return So.oe(t, this.It, e, this.referenceDelegate);
    }, t.prototype.getTargetCache = function() {
        return this.Cs;
    }, t.prototype.getRemoteDocumentCache = function() {
        return this.remoteDocumentCache;
    }, t.prototype.getIndexManager = function(t) {
        return new po(t, this.It.re.databaseId);
    }, t.prototype.getDocumentOverlayCache = function(t) {
        ...
        return this.ri.runTransaction(t, u, s, (function(i) {
            return o = new Ci(i, r.Ss ? r.Ss.next() : qt.at), "readwrite-primary" === e ? r.fi(o).next((function(t) {
                return !!t || r.di(o);
            })).next((function(e) {
                if (!e) throw M("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
    ...
    t.prototype.Vi = function(t) {
        var e = this;
        return fu(t).get("owner").next((function(t) {
            if (null !== t && e.pi(t.leaseTimestampMs, 5e3) && !e.Ei(t.ownerId) && !e.mi(t) && !(e.Ys || e.allowTabSynchronization && t.allowTabSynchronization)) throw new j(K.FAILED_PRECONDITION, lu);
        }));
    }, 
    /**
...
var vu = /** @class */ function() {
    ...
    return t.Ci = function(e, n) {
        for (var r = pr(), i = pr(), o = 0, u = n.docChanges; o < u.length; o++) {
            var s = u[o];
            switch (s.type) {
              case 0 /* Added */ :
                r = r.add(s.doc.key);
    ...
    t.prototype.ki = function(t, e) {
        ...
        return this.indexManager.getIndexType(t, r).next((function(i) {
            ...
            e = fn(e, null, "F" /* First */), r = hn(e)), n.indexManager.getDocumentsMatchingTarget(t, r).next((function(i) {
                var o = pr.apply(void 0, i);
                return n.Ni.getDocuments(t, o).next((function(i) {
                    return n.indexManager.getMinOffset(t, r).next((function(r) {
                        var u = n.Fi(e, i);
                        return n.$i(e, u, o, r.readTime) ? n.ki(t, fn(e, null, "F" /* First */)) : n.Bi(t, u, e, r);
                    }));
                }));
            })));
        }));
    ...
    return t.prototype.Qi = function(t) {
        ...
        this.mutationQueue = this.persistence.getMutationQueue(t, this.indexManager), this.localDocuments = new Xo(this.Gi, this.mutationQueue, this.documentOverlayCache, this.indexManager), 
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            ...
            return n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t, function(t) {
                for (var e = pr(), n = 0; n < t.mutationResults.length; ++n) t.mutationResults[n].transformResults.length > 0 && (e = e.add(t.batch.mutations[n].key));
                return e;
            }(e));
        })).next((function() {
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.targetChanges.forEach((function(o, s) {
            ...
            if (a) {
                ...
                e.targetMismatches.has(s) ? c = c.withResumeToken(Zt.EMPTY_BYTE_STRING, st.min()).withLastLimboFreeSnapshotVersion(st.min()) : o.resumeToken.approximateByteSize() > 0 && (c = c.withResumeToken(o.resumeToken, r)), 
                i = i.insert(s, c), 
 ...
 */ function Tu(t, e, n) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, o) {
            ...
            r = r.insert(n, o)) : L("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", u.version, " Watch version:", o.version);
        })), {
            Wi: r,
            zi: i
        };
...
function _u(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = G(t), o = e.Ui.get(r), u = i ? "readwrite" : "readwrite-primary", n.label = 1;
              ...
              case 4:
                if (!Ot(s = n.sent())) throw s;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return L("LocalStore", "Failed to update sequence numbers for target " + r + ": " + s), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function xu(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return r.Li.getDocumentsMatchingQuery(t, e, n ? i : st.min(), n ? o : pr());
        })).next((function(t) {
            return Cu(r, mn(e), t), {
                documents: t,
                Hi: o
...
function Au(t, e) {
    ...
    // TODO(indexing): Consider removing the default value.
        ...
        return n.Gi.getAllFromCollectionGroup(t, e, bt(r, -1), 
 ...
 */ function ku(t, r, i, o) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                for (e = G(t), u = pr(), s = or(), a = 0, c = i; a < c.length; a++) l = c[a], h = r.Ji(l.metadata.name), 
                ...
                return d = e.Gi.newChangeBuffer({
                    ...
                    return hn(on(ct.fromString("__bundle__/docs/" + t)));
                }(o)) ];
 ...
 */ function Ou(t, r, i) {
    return void 0 === i && (i = pr()), e(this, void 0, void 0, (function() {
        var e, o;
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Du(t, hn(ji(r.bundledQuery))) ];
...
/** Assembles the key for a query state in WebStorage */ function Lu(t, e) {
...
var Mu = /** @class */ function() {
    ...
    return t.Zi = function(e, n, r) {
        ...
        u ? new t(e, n, o.state, i) : (M("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.Zi = function(e, n) {
        ...
        o ? new t(e, i.state, r) : (M("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.tr = function() {
        var t = {
            state: this.state,
    ...
    return t.Zi = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = yr(), u = 0; i && u < r.activeTargetIds.length; ++u) i = ce(r.activeTargetIds[u]), 
        o = o.add(r.activeTargetIds[u]);
        return i ? new t(e, o) : (M("SharedClientState", "Failed to parse client data for instance '" + e + "': " + n), 
        null);
    }, t;
}(), qu = /** @class */ function() {
    function t(t, e) {
    ...
    return t.Zi = function(e) {
        var n = JSON.parse(e);
        return "object" == typeof n && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (M("SharedClientState", "Failed to parse online state: " + e), 
        null);
    }, t;
}(), Uu = /** @class */ function() {
    function t() {
        this.activeTargetIds = yr();
    }
    ...
    function t(t, e, n, r, i) {
        ...
        this.ur = new Kt(rt), this.started = !1, 
        /**
        ...
        }(this.persistenceKey), this.ur = this.ur.insert(this.sr, new Uu), this.lr = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.C = function(t) {
        ...
        // by another tab
            ...
            var n = this.storage.getItem(Lu(this.persistenceKey, t));
            if (n) {
                var r = Pu.Zi(t, n);
                r && (e = r.state);
            }
        ...
        // `Window.addEventListener`.
            ...
            if (L("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.ar) return void M("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                        ...
                        switch (n.label) {
                          ...
                          case 4:
                            return i.key !== this.hr ? [ 3 /*break*/ , 5 ] : (s = function(t) {
                                ...
                                return e;
                            }(i.newValue), s !== qt.at && this.sequenceNumberHandler(s), [ 3 /*break*/ , 7 ]);

                          case 5:
                            return i.key !== this.mr ? [ 3 /*break*/ , 7 ] : (a = this.Or(i.newValue), [ 4 /*yield*/ , Promise.all(a.map((function(t) {
                                return c.syncEngine.Mr(t);
                            }))) ]);
        ...
        var r = Lu(this.persistenceKey, t), i = new Pu(t, e, n);
        this.setItem(r, i.tr());
    ...
    t.prototype.yr = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.Fr(t.batchId, t.state, t.error) ] : (L("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    function t() {
        this.Lr = new Uu, this.Ur = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.Lr = new Uu, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.fo = function(t, e, n, r) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case E.HTTP_ERROR:
                        ...
                        o(new j(K.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        this.useFetchStreams && (u.xmlHttpFactory = new D({})), this.lo(u.initMessageHeaders, e, n), 
        ...
        var s = r.join("");
        L("Connection", "Creating WebChannel: " + s, u);
        var a = i.createWebChannel(s, u), c = !1, l = !1, h = new zu({
            Hr: function(t) {
                l ? L("Connection", "Not sending because WebChannel is closed:", t) : (c || (L("Connection", "Opening WebChannel transport."), 
                a.open(), c = !0), L("Connection", "WebChannel sending:", t), a.send(t));
            },
            Jr: function() {
                return a.close();
            }
 ...
 */
                    function(t) {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        var e = Xn[t];
                        if (void 0 !== e) return nr(e);
                    }(o), s = i.message;
                    void 0 === u && (u = K.INTERNAL, s = "Unknown error status: " + o + " with message " + i.message), 
    ...
    return Object.defineProperty(t.prototype, "co", {
        get: function() {
        ...
        var o = this.ho(t, e);
        L("RestConnection", "Sending: ", o, n);
        var u = {};
        return this.lo(u, r, i), this.fo(t, o, u, n).then((function(t) {
            return L("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw P("RestConnection", t + " failed with error: ", e, "url: ", o, "request:", n), 
            e;
        }));
    }, t.prototype._o = function(t, e, n, r, i, o) {
        // The REST API automatically aggregates all of the streamed results, so we
        // can just use the normal invoke() method.
        return this.ao(t, e, n, r, i);
    }, 
    /**
 ...
 */ var Zu = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Hs = t, this.timerId = e, this.mo = n, this.yo = r, this.po = i, this.Io = 0, 
        this.To = null, 
    ...
    t.prototype.Ro = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && L("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Io + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
        this.To = this.Hs.enqueueAfterDelay(this.timerId, i, (function() {
    ...
    t.prototype.jo = function(t) {
        ...
        return L("PersistentStream", "close with error: " + t), this.stream = null, this.close(4 /* Error */ , t);
    }, 
    /**
    ...
    return t(n, e), n.prototype.Wo = function(t, e) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                // if unset
                var r = function(t) {
                    return "NO_CHANGE" === t ? 0 /* NoChange */ : "ADD" === t ? 1 /* Added */ : "REMOVE" === t ? 2 /* Removed */ : "CURRENT" === t ? 3 /* Current */ : "RESET" === t ? 4 /* Reset */ : q();
                }(e.targetChange.targetChangeType || "NO_CHANGE"), i = e.targetChange.targetIds || [], o = function(t, e) {
                    return t.gt ? (U(void 0 === e || "string" == typeof e), Zt.fromBase64String(e || "")) : (U(void 0 === e || e instanceof Uint8Array), 
                    Zt.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), u = e.targetChange.cause, s = u && function(t) {
                    var e = void 0 === t.code ? K.UNKNOWN : nr(t.code);
                    return new j(e, t.message || "");
                }(u);
                n = new Ir(r, i, o, s || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = Mr(t, a.document.name), l = Or(a.document.updateTime), h = new ke({
                    mapValue: {
    ...
    n.prototype.Ho = function(t) {
        ...
        e.database = qr(this.It), e.addTarget = function(t, e) {
            ...
            return (n = Fe(r) ? {
                ...
                query: zr(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Cr(t, e.resumeToken) : e.snapshotVersion.compareTo(st.min()) > 0 && (
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (U(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? Or(t.updateTime) : Or(e);
                        ...
                        n = Or(e)), new Mn(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
        ...
        i.enqueueAndForget((function() {
            return e(s, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return fs(this) ? (L("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return e(this, void 0, void 0, (function() {
                                var e;
                                return n(this, (function(n) {
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(a) {
            switch (a.label) {
              ...
              case 3:
                return o = a.sent(), L("RemoteStore", "Failed to remove targets %s: %s ", r.targetIds.join(","), o), 
                [ 4 /*yield*/ , ms(t, o) ];
              ...
              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Iu(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            var r = new Li(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            as(t, r);
                        }
              ...
              case 11:
                return L("RemoteStore", "Failed to raise snapshot:", s = a.sent()), [ 4 /*yield*/ , ms(t, s) ];
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 4:
                return u = n.sent(), [ 4 /*yield*/ , ms(e, u) ];
...
function _s(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return (e = G(t)).asyncQueue.verifyOperationInProgress(), L("RemoteStore", "RemoteStore received new credentials"), 
                i = fs(e), 
 ...
 */ function ks(t, e) {
    if (M("AsyncQueue", e + ": " + t), Ot(t)) return new j(K.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Os = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = sr(), this.sortedSet = new Kt(this.comparator)
        /**
 ...
 */ function Ps(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                if (e = G(t), i = r.query, o = !1, (u = e.queries.get(i)) || (o = !0, u = new Ls), 
                !o) return [ 3 /*break*/ , 4 ];
                n.label = 1;
...
function Fs(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o, u, s;
        return n(this, (function(n) {
            return e = G(t), i = r.query, o = !1, (u = e.queries.get(i)) && (s = u.listeners.indexOf(r)) >= 0 && (u.listeners.splice(s, 1), 
    ...
    t.prototype.complete = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , ku(this.localStore, new js(this.It), this.documents, this.Mu.id) ];

                  case 1:
                    t = n.sent(), e = this.$u(this.documents), r = 0, i = this.queries, n.label = 2;

                  case 2:
                    return r < i.length ? (o = i[r], [ 4 /*yield*/ , Ou(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
 ...
 */ var Ws = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = pr(), this.Gu = gn(t), this.Qu = new Os(this.Gu);
    }
    ...
    t.prototype.Ju = function(t) {
        ...
        // updating many documents.
                var e = this.Ku;
        this.Ku = pr(), this.Qu.forEach((function(e) {
            t.Zu(e.key) && (t.Ku = t.Ku.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Ku.has(e) || n.push(new Hs(e));
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.sc = {}, this.ic = new rr((function(t) {
            return pn(t);
        }), dn), this.rc = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.uc = new Kt(ft.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.cc = new Map, this.ac = new $o, 
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                i = u.targetId, e.sharedClientState.addLocalQueryTarget(i), o = u.view.ec(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , Du(e.localStore, hn(r)) ];
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, u), [ 2 /*return*/ , (da(t, r.targetId, s.Xu), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
...
/** Stops listening to the query. */ function ea(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o;
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = G(t), i = e.ic.get(r), (o = e.rc.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.rc.set(i.targetId, o.filter((function(t) {
                    return !dn(t, r);
            ...
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r, i = G(t), o = ut.now(), u = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), pr());
                    return i.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        ...
                        return i.Gi.getEntries(t, u).next((function(t) {
                            ...
                            var u = [], s = 0, a = e; s < a.length; s++) {
                                var c = a[s], l = Kn(c, n.get(c.key).overlayedDocument);
                                null != l && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                u.push(new zn(c.key, l, Oe(l.value.mapValue), Pn.exists(!0)));
                            }
              ...
              case 2:
                return o = n.sent(), e.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    var r = t.hc[t.currentUser.toKey()];
                    r || (r = new Kt(rt)), r = r.insert(e, n), t.hc[t.currentUser.toKey()] = r;
                }(e, o.batchId, i), [ 4 /*yield*/ , ya(e, o.changes) ];

              case 3:
                return n.sent(), [ 4 /*yield*/ , ws(e.remoteStore) ];

              case 4:
                return n.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return u = n.sent(), s = ks(u, "Failed to persist write"), i.reject(s), [ 3 /*break*/ , 6 ];
            ...
            switch (n.label) {
              ...
              case 2:
                ...
                r.targetChanges.forEach((function(t, n) {
                    ...
                    t.addedDocuments.size > 0 ? r.nc = !0 : t.modifiedDocuments.size > 0 ? U(r.nc) : t.removedDocuments.size > 0 && (U(r.nc), 
                    r.nc = !1));
                })), [ 4 /*yield*/ , ya(e, i, r) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (e = G(t)).sharedClientState.updateQueryState(r, "rejected", i), o = e.cc.get(r), 
                (u = o && o.key) ? (
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , bu(e.localStore, r) ];
              ...
              case 2:
                ...
                la(e, i, /*error=*/ null), ca(e, i), e.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , ya(e, o) ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 2:
                ...
                // listen events.
                la(e, r, i), ca(e, r), e.sharedClientState.updateMutationState(r, "rejected", i), 
                [ 4 /*yield*/ , ya(e, o) ];
 ...
 */ function aa(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                fs((e = G(t)).remoteStore) || L("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                n.label = 1;
              ...
              case 2:
                return -1 === (i = n.sent()) ? [ 2 /*return*/ , void r.resolve() ] : ((o = e.lc.get(i) || []).push(r), 
                e.lc.set(i, o), [ 3 /*break*/ , 4 ]);

              case 3:
                return u = n.sent(), s = ks(u, "Initialization of waitForPendingWrites() operation failed"), 
...
function la(t, e, n) {
    var r = G(t), i = r.hc[r.currentUser.toKey()];
    // NOTE: Mutations restored from persistence won't have callbacks, so it's
    // okay for there to be no callback for this ID.
    if (i) {
        var o = i.get(e);
        o && (n ? o.reject(n) : o.resolve(), i = i.remove(e)), r.hc[r.currentUser.toKey()] = i;
    }
}

function ha(t, e, n) {
    void 0 === n && (n = null), t.sharedClientState.removeLocalQueryTarget(e);
    for (var r = 0, i = t.rc.get(e); r < i.length; r++) {
        var o = i[r];
        t.ic.delete(o), n && t.sc.wc(o, n);
    }
    t.rc.delete(e), t.isPrimaryClient && t.ac.ls(e).forEach((function(e) {
        t.ac.containsKey(e) || 
...
function fa(t, e) {
    ...
    var n = t.uc.get(e);
    null !== n && (ss(t.remoteStore, n), t.uc = t.uc.remove(e), t.cc.delete(n), va(t));
}

function da(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Ws ? (t.ac.addReference(o.key, e), pa(t, o)) : o instanceof Hs ? (L("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.ac.removeReference(o.key, e), t.ac.containsKey(o.key) || 
        // We removed the last reference for this key
        fa(t, o.key)) : q();
    }
}
...
function pa(t, e) {
    ...
    t.uc.get(n) || t.oc.has(r) || (L("SyncEngine", "New document in limbo: " + n), t.oc.add(r), 
    va(t));
}
 ...
 */ function va(t) {
    for (;t.oc.size > 0 && t.uc.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.oc.delete(e);
        var n = new ft(ct.fromString(e)), r = t.fc.next();
        t.cc.set(r, new Zs(n)), t.uc = t.uc.insert(n, r), us(t.remoteStore, new Li(hn(on(n.path)), r, 2 /* LimboResolution */ , qt.at));
    }
}
...
function ya(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = G(t), u = [], s = [], a = [], o.ic.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.ic.forEach((function(t, e) {
                    a.push(o._c(e, r, i).then((function(t) {
...
function ma(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return (e = G(t)).currentUser.isEqual(r) ? [ 3 /*break*/ , 3 ] : (L("SyncEngine", "User change. New user:", r.toKey()), 
                [ 4 /*yield*/ , wu(e.localStore, r) ]);
              ...
              case 1:
                ...
                e.sharedClientState.handleUserChange(r, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , ya(e, i.ji) ];
...
function ga(t, e) {
    var n = G(t), r = n.cc.get(e);
    if (r && r.nc) return pr().add(r.key);
    var i = pr(), o = n.rc.get(e);
    if (!o) return i;
    for (var u = 0, s = o; u < s.length; u++) {
        var a = s[u], c = n.ic.get(a);
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return i = n.sent(), o = r.view.tc(i), [ 2 /*return*/ , (e.isPrimaryClient && da(e, r.targetId, o.Xu), 
                o) ];
            }
        }));
    }));
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return null === (u = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , ws(e.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                la(e, r, o || null), ca(e, r), function(t, e) {
                    G(G(t).mutationQueue).An(e);
                }(e.localStore, r)) : q(), n.label = 4;

              case 4:
                return [ 4 /*yield*/ , ya(e, u) ];
...
function Ta(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = G(t), i = [], o = [], u = 0, s = r, n.label = 1;

              case 1:
                return u < s.length ? (a = s[u], c = void 0, (l = e.rc.get(a)) && 0 !== l.length ? [ 4 /*yield*/ , Du(e.localStore, hn(l[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return h < f.length ? (d = f[h], p = e.ic.get(d), [ 4 /*yield*/ , wa(e, p) ]) : [ 3 /*break*/ , 6 ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                if (!((u = e.rc.get(r)) && u.length > 0)) return [ 3 /*break*/ , 7 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 1 ];
              ...
              case 5:
                return n.sent(), ha(e, r, o), [ 3 /*break*/ , 7 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 4:
                    return i._updateProgress(zs(e)), o = new Qs(e, t.localStore, r.It), [ 4 /*yield*/ , r.mc() ];
                  ...
                  case 7:
                    return (s = n.sent()) && i._updateProgress(s), [ 4 /*yield*/ , r.mc() ];
                  ...
                  case 11:
                    return a = n.sent(), [ 4 /*yield*/ , ya(t, a.Lu, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 13:
                    return [ 2 /*return*/ , (
                    // Save metadata, so loading the same bundle will skip.
                    n.sent(), i._completeWith(a.progress), Promise.resolve(a.Bu)) ];

                  case 14:
                    return [ 2 /*return*/ , (P("SyncEngine", "Loading bundle failed with " + (c = n.sent())), 
...
var ka = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.It = Xu(t.databaseInfo.databaseId), this.sharedClientState = this.gc(t), 
                    this.persistence = this.yc(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.localStore = this.Ic(t), this.gcScheduler = this.Tc(t, this.localStore), 
                    this.indexBackfillerScheduler = this.Ec(t, this.localStore), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return gu(this.persistence, new yu, t.initialUser, this.It);
    }, t.prototype.yc = function(t) {
        return new ou(su.Bs, this.It);
    ...
    function i(t, e, n) {
        var i = this;
        return (i = r.call(this) || this).Ac = t, i.cacheSizeBytes = e, i.forceOwnership = n, 
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), [ 4 /*yield*/ , this.Ac.initialize(this, t) ];
                  ...
                  case 3:
                    // Enqueue writes from a previous session
                    return n.sent(), [ 4 /*yield*/ , ws(this.Ac.remoteStore) ];
        ...
        return new Mo(n, t.asyncQueue, e);
    }, i.prototype.Ec = function(t, e) {
        var n = new Ft(e, this.persistence);
        return new Pt(t.asyncQueue, n);
    }, i.prototype.yc = function(t) {
        var e = pu(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Io.withCacheSize(this.cacheSizeBytes) : Io.DEFAULT;
        return new hu(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Hu(), Yu(), this.It, this.sharedClientState, !!this.forceOwnership);
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        ...
        var e = Hu();
        if (!Bu.C(e)) throw new j(K.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
    ...
    return t.prototype.initialize = function(t, r) {
        ...
        var e, n = Xu(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Wu(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return ia(u.syncEngine, t, 0 /* RemoteStore */);
        }, o = ju.C() ? new ju : new Ku, new rs(e, n, r, i, o);
 ...
 * @internal
 */ function Ma(t, e, n, r) {
    if (!0 === e && !0 === r) throw new j(K.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function Pa(t) {
    if (!ft.isDocumentKey(t)) throw new j(K.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Fa(t) {
    if (ft.isDocumentKey(t)) throw new j(K.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function qa(t) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Ga = new Map, Ka = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
    ...
    function t(t, e, n, r) {
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Ka({}), 
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new Ka(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            if (!t) return new W;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = Ga.get(t)) && (L("ComponentProvider", "Removing Datastore"), 
        Ga.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
...
function Qa(t, e, n, r) {
    var i;
    void 0 === r && (r = {});
    var o = (t = Ua(t, ja))._getSettings();
    if ("firestore.googleapis.com" !== o.host && o.host !== e && P("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        t._authCredentials = new H(new z(u, s));
    }
}
 ...
 */ var za = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, on(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function Ya(t, e) {
    ...
    if (t = v(t), La("collection", "path", e), t instanceof ja) {
        var o = ct.fromString.apply(ct, r([ e ], n));
        return Fa(o), new Ha(t, /* converter= */ null, o);
    }
    if (!(t instanceof za || t instanceof Ha)) throw new j(K.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t._path.child(ct.fromString.apply(ct, r([ e ], n)));
    return Fa(u), new Ha(t.firestore, 
    /* converter= */ null, u);
}
 ...
 */ function Xa(t, e) {
    if (t = Ua(t, ja), La("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new j(K.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new Wa(t, 
    /* converter= */ null, 
    /**
...
function Za(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = nt.R()), La("doc", "path", e), t instanceof ja) {
        var o = ct.fromString.apply(ct, r([ e ], n));
        return Pa(o), new za(t, 
        /* converter= */ null, new ft(o));
    }
    if (!(t instanceof za || t instanceof Ha)) throw new j(K.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t._path.child(ct.fromString.apply(ct, r([ e ], n)));
    return Pa(u), new za(t.firestore, t instanceof Ha ? t.converter : null, new ft(u));
}
 ...
 * Firestore database.
 */ function Ja(t, e) {
    return t = v(t), e = v(e), (t instanceof za || t instanceof Ha) && (e instanceof za || e instanceof Ha) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function $a(t, e) {
    return t = v(t), e = v(e), t instanceof Wa && e instanceof Wa && t.firestore === e.firestore && dn(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 */ var ec = /** @class */ function() {
    ...
    t.prototype.Vc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.Sc() ];

                  case 1:
                    return null === (t = n.sent()) ? [ 2 /*return*/ , null ] : (e = this.vc.decode(t), 
                    r = Number(e), isNaN(r) && this.Dc("length string (" + e + ") is not valid number"), 
                    [ 4 /*yield*/ , this.Cc(r) ]);
    ...
    /** First index of '{' from the underlying buffer. */ t.prototype.xc = function() {
    ...
    t.prototype.Sc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.xc() < 0 ? [ 4 /*yield*/ , this.Nc() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    (t = this.xc()) < 0 && this.Dc("Reached the end of bundle when a length string is expected."), 
    ...
    t.prototype.Cc = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.buffer.length < t ? [ 4 /*yield*/ , this.Nc() ] : [ 3 /*break*/ , 3 ];

                  case 1:
                    n.sent() && this.Dc("Reached the end of bundle when more is expected."), n.label = 2;
                  ...
                  case 3:
                    ...
                    return e = this.vc.decode(this.buffer.slice(0, t)), [ 2 /*return*/ , (this.buffer = this.buffer.slice(t), 
                    e) ];
                }
            }));
        }));
    ...
    return t.prototype.run = function() {
        ...
        return function(t, r) {
            ...
            return U("number" == typeof n), Promise.resolve(new ic(t.query, {
                count: n
            }));
        }));
    }, t;
                    ...
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = G(t), i = qr(e.It) + "/documents", o = {
                                        documents: r.map((function(t) {
                                            return Lr(e.It, t);
                                        }))
                                    }, [ 4 /*yield*/ , e._o("BatchGetDocuments", i, o, r.length) ];
                                    ...
                                    return u = n.sent(), s = new Map, u.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Mr(t, e.found.name), r = Or(e.found.updateTime), i = new ke({
                                                    mapValue: {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var n = ft.fromPath(e);
                        r.mutations.push(new $n(n, r.precondition(n)));
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(st.min()) ? Pn.exists(!1) : Pn.updateTime(e) : Pn.none();
    }, 
    /**
    ...
    return t.prototype.run = function() {
        ...
        this.No.Ro((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new uc(this.datastore), (e = this.Mc(t)) && e.then((function(e) {
    ...
    i, o) {
        ...
        this.user = C.UNAUTHENTICATED, this.clientId = nt.R(), this.authCredentialListener = function() {
            ...
            return L("FirestoreClient", "Received new app check token=", t), u.appCheckCredentialListener(t, u.user);
        }));
    }
            ...
            return e(t, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 5:
                        return t = n.sent(), e = ks(t, "Failed to shutdown persistence"), r.reject(e), [ 3 /*break*/ , 6 ];
                ...
                return s.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return e(u, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , wu(r.localStore, t) ];
...
function lc(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , hc(t) ];
...
function hc(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.offlineComponents ? [ 3 /*break*/ , 2 ] : (L("FirestoreClient", "Using default OfflineComponentProvider"), 
                [ 4 /*yield*/ , cc(t, new ka) ]);
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                ...
                r.onUnlisten = ea.bind(null, e.syncEngine), r) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function wc(t, r, i) {
    var o = this;
    void 0 === i && (i = {});
    var u = new Q;
...
var Ic = /** @class */ function() {
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Hc((function() {
            return e.Uc && e.Qc ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Jc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.Lc.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;
        ...
        var e = this, n = this.Bc.then((function() {
 ...
 */
    ...
    t.prototype.Xc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.Bc ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.Bc) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
    ...
    t.prototype.Zc = function(t) {
        for (var e = 0, n = this.qc; e < n.length; e++) {
    ...
    t.prototype.ta = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            e.qc.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.qc; n < r.length; n++) {
                var i = r[n];
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.Yc = function(t) {
        // NOTE: indexOf / slice are O(n), but delayedOperations is expected to be small.
        var e = this.qc.indexOf(t);
        this.qc.splice(e, 1);
    }, t;
}();
...
var Tc = /** @class */ function() {
    ...
    function n(t, n, r, i) {
        ...
        /**
             ...
             */
        return (o = e.call(this, t, n, r, i) || this).type = "firestore", o._queue = new Ic, 
...
function Ac(t) {
    ...
    t._firestoreClient = new ac(t._authCredentials, t._appCheckCredentials, t._queue, r);
}
 ...
 */ function Oc(t, r, i) {
    ...
    return t.asyncQueue.enqueue((function() {
         ...
         */
                    function(t) {
                        return "FirebaseError" === t.name ? t.code === K.FAILED_PRECONDITION || t.code === K.UNIMPLEMENTED : !("undefined" != typeof DOMException && t instanceof DOMException) || (22 === t.code || 20 === t.code || 
                        // Firefox Private Browsing mode disables IndexedDb and returns
                        // INVALID_STATE for any usage.
                        11 === t.code);
                    }(o = e)) throw o;
                    return P("Error enabling offline persistence. Falling back to persistence disabled: " + o), 
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    ...
                    }(pu(t._databaseId, t._persistenceKey)) ];
...
}(), zc = /^__.*__$/, Wc = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new zn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Qn(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Hc = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Xc = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.ia = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.ia({
            path: n,
            oa: !1
        });
        return r.ua(t), r;
        ...
        return yl(t, this.settings.methodName, this.settings.la || !1, this.path, this.settings.fa);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.ua(this.path.get(t));
    }, t.prototype.ua = function(t) {
        if (0 === t.length) throw this.ha("Document fields must not be empty");
        if (Yc(this.sa) && zc.test(t)) throw this.ha('Document fields cannot begin and end with "__"');
    }, t;
}(), Zc = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.It = n || Xu(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.da = function(t, e, n, r) {
 ...
 * classes.
 */ function Jc(t) {
    var e = t._freezeSettings(), n = Xu(t._databaseId);
    return new Zc(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function $c(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var u = t.da(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    fl("Data must be an object, but it was:", u, r);
    var s, a, c = ll(r, u);
    if (o.merge) s = new Yt(u.fieldMask), a = u.fieldTransforms; else if (o.mergeFields) {
        for (var l = [], h = 0, f = o.mergeFields; h < f.length; h++) {
            var d = dl(e, f[h], n);
            if (!u.contains(d)) throw new j(K.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            ml(l, d) || l.push(d);
        }
        s = new Yt(l), a = u.fieldTransforms.filter((function(t) {
            return s.covers(t.field);
        }));
    } else s = null, a = u.fieldTransforms;
    return new Wc(new ke(c), s, a);
}
...
/** Parse update data from an update() call. */ function ul(t, e, n, r) {
    var i = t.da(1 /* Update */ , e, n);
    fl("Data must be an object, but it was:", i, r);
    var o = [], u = ke.empty();
    Bt(r, (function(t, r) {
        var s = vl(e, t, n);
    ...
    var s = new Yt(o);
    return new Hc(u, s, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function sl(t, e, n, r, i, o) {
    var u = t.da(1 /* Update */ , e, n), s = [ dl(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new j(K.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) s.push(dl(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], h = ke.empty(), f = s.length - 1; f >= 0; --f) if (!ml(l, s[f])) {
        var d = s[f], p = a[f];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = v(p);
    ...
    var g = new Yt(l);
    return new Hc(h, g, u.fieldTransforms);
}
 ...
 */ function al(t, e, n, r) {
    return void 0 === r && (r = !1), cl(n, t.da(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function cl(t, e) {
    ...
    // from firestore-exp.
    t = v(t))) return fl("Unsupported field value:", e, t), ll(t, e);
    if (t instanceof jc) 
    ...
    return function(t, e) {
        ...
        if (!Yc(e.sa)) throw e.ha(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof Bc) return {
            bytesValue: Cr(e.It, t._byteString)
        };
        if (t instanceof za) {
...
function hl(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ut || t instanceof Qc || t instanceof Bc || t instanceof za || t instanceof jc);
}
...
function fl(t, e, n) {
    if (!hl(n) || !function(t) {
        ...
        var r = qa(n);
        throw "an object" === r ? e.ha(t + " a custom object") : e.ha(t + " " + r);
    }
}
 ...
 */ function dl(t, e, n) {
    ...
    // FieldPath.
    (e = v(e)) instanceof Gc) return e._internalPath;
    if ("string" == typeof e) return vl(t, e);
    throw yl("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function vl(t, e, n) {
    if (e.search(pl) >= 0) throw yl("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (Gc.bind.apply(Gc, r([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
        throw yl("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
...
function yl(t, e, n, r, i) {
    ...
    a += ")"), new j(K.INVALID_ARGUMENT, (s += ". ") + t + a)
 ...
 */ var gl = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new wl(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(bl("DocumentSnapshot.get", t));
 ...
 */
function bl(t, e) {
    return "string" == typeof e ? vl(t, e) : e instanceof Gc ? e._internalPath : e._delegate._internalPath;
}
 ...
 * limitations under the License.
 */ function Il(t) {
    if ("L" /* Last */ === t.limitType && 0 === t.explicitOrderBy.length) throw new j(K.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Sl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).ma = t, i.ga = n, i.ya = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Jc(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new j(K.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on documentId().");
 ...
 */
                ...
                throw i === e.op ? new j(K.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new j(K.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, f), f;
        }(t._query, 0, e, t.firestore._databaseId, this.ma, this.ga, this.ya);
...
var kl = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Pl(t, this.type, this.Ea, this.Aa);
        return new Wa(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function Pl(t, e, n, r) {
    if (n[0] = v(n[0]), n[0] instanceof gl) return function(t, e, n, r, i) {
        if (!r) throw new j(K.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], u = 0, s = ln(t); u < s.length; u++) {
            var a = s[u];
            if (a.field.isKeyField()) o.push(we(e, r.key)); else {
                var c = r.data.field(a.field);
                if (ne(c)) throw new j(K.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var l = a.field.canonicalString();
                    throw new j(K.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + l + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > u.length) throw new j(K.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (u[a].field.isKeyField()) {
                if ("string" != typeof c) throw new j(K.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!cn(t) && -1 !== c.indexOf("/")) throw new j(K.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var l = t.path.child(ct.fromString(c));
                if (!ft.isDocumentKey(l)) throw new j(K.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by documentId(), the value passed to " + r + "() must result in a valid document path, but '" + l + "' is not because it contains an odd number of segments.");
                var h = new ft(l);
                s.push(we(e, h));
            } else {
                var f = al(n, r, c);
...
function Fl(t, e, n) {
    if ("string" == typeof (n = v(n))) {
        ...
        if (!cn(e) && -1 !== n.indexOf("/")) throw new j(K.INVALID_ARGUMENT, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(ct.fromString(n));
        if (!ft.isDocumentKey(r)) throw new j(K.INVALID_ARGUMENT, "Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return we(t, new ft(r));
    }
    if (n instanceof za) return we(t, n._key);
    throw new j(K.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: " + qa(n) + ".");
}
 ...
 */ var Bl = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        switch (void 0 === e && (e = "none"), fe(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.convertBytes(ee(t.bytesValue));
        ...
        return new Qc(te(t.latitude), te(t.longitude));
        ...
        switch (e) {
          ...
          case "estimate":
            return this.convertTimestamp(ie(t));
        ...
        U(ni(n));
        var r = new ue(n.get(1), n.get(3)), i = new ft(n.popFirst(5));
        return r.isEqual(e) || 
        // TODO(b/64130202): Somehow support foreign references.
        M("Document " + i + " contains a document reference within a different database (" + r.projectId + "/" + r.database + ") which is not supported. It will be treated as a reference in the current database (" + e.projectId + "/" + e.database + ") instead."), 
        i;
    }, t;
}();
...
var Kl = /** @class */ function(e) {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new zl(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(bl("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(gl), zl = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(Ql), Wl = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new jl(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new zl(n._firestore, n._userDataWriter, r.key, r, new jl(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        function(t, e) {
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new zl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new jl(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 */ function Jl(t) {
    ...
    return function(t, r) {
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 2:
                                        return o = n.sent(), u = ks(o, "Failed to get document '" + r + " from cache"), 
        ...
        return new Ql(r, o, t._key, e, new jl(null !== e && e.hasLocalMutations, 
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 1:
                                        return e = n.sent(), o = new Ys(r, e.Hi), u = o.Wu(e.documents), s = o.applyChanges(u, 
                                        /* updateLimboDocuments= */ !1), i.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = n.sent(), c = ks(a, "Failed to execute query '" + r + " against cache"), 
...
function rh(t, e, n) {
    t = Ua(t, za);
    var r = Ua(t.firestore, Dc), i = Gl(t.converter, e, n);
    return ch(r, [ $c(Jc(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Pn.none()) ]);
}

function ih(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = Ua(t, za);
    var o = Ua(t.firestore, Dc), u = Jc(o);
    return ch(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = v(e)) || e instanceof Gc ? sl(u, "updateDoc", t._key, e, n, r) : ul(u, "updateDoc", t._key, e)).toMutation(t._key, Pn.exists(!0)) ]);
}
 ...
 */ function oh(t) {
    return ch(Ua(t.firestore, Dc), [ new Jn(t._key, Pn.none()) ]);
}
 ...
 */ function uh(t, e) {
    var n = Ua(t.firestore, Dc), r = Za(t), i = Gl(t.converter, e);
    return ch(n, [ $c(Jc(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Pn.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function sh(t) {
    ...
    if (t instanceof za) h = Ua(t.firestore, Dc), f = on(t._key.path), l = {
        next: function(e) {
            u[c] && u[c](lh(h, t, e));
        },
        error: u[c + 1],
        ...
        var y = Ua(t, Wa);
        h = Ua(y.firestore, Dc), f = y._query;
        var m = new Zl(h);
        l = {
            next: function(t) {
                u[c] && u[c](new Wl(h, m, y, t));
            },
            error: u[c + 1],
            complete: u[c + 2]
        }, Il(t._query);
    ...
    return function(t, r, i, o) {
        var u = this, s = new ec(o), a = new Gs(r, s, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return e(u, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
            ...
            s.bc(), t.asyncQueue.enqueueAndForget((function() {
                return e(u, void 0, void 0, (function() {
                    var e;
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e = Fs, [ 4 /*yield*/ , gc(t) ];
...
function ah(t, r) {
    return function(t, r) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            o.bc(), t.asyncQueue.enqueueAndForget((function() {
                return e(i, void 0, void 0, (function() {
                    var e;
                    return n(this, (function(n) {
                        switch (n.label) {
 ...
 */ function lh(t, e, n) {
    var r = n.docs.get(e._key), i = new Zl(t);
    return new Ql(t, i, e._key, r, new jl(n.hasPendingWrites, n.fromCache), e.converter);
}
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            return e(o, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return n.trys.push([ 0, 5, , 6 ]), e = fs, [ 4 /*yield*/ , vc(t) ];

                      case 1:
                        return e.apply(void 0, [ n.sent() ]) ? [ 4 /*yield*/ , mc(t) ] : [ 3 /*break*/ , 3 ];

                      case 2:
                        return o = n.sent(), s = new oc(r, o, i).run(), u.resolve(s), [ 3 /*break*/ , 4 ];

                      case 3:
                        u.reject(new j(K.UNAVAILABLE, "Failed to get count result because the client is offline.")), 
                        n.label = 4;
                      ...
                      case 5:
                        return a = n.sent(), u.reject(a), [ 3 /*break*/ , 6 ];
 ...
 */ var dh = {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = vh(t, this._firestore), i = Gl(r.converter, e, n), o = $c(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Pn.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, u = vh(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = v(e)) || e instanceof Gc ? sl(this._dataReader, "WriteBatch.update", u._key, e, n, r) : ul(this._dataReader, "WriteBatch.update", u._key, e), 
        this._mutations.push(o.toMutation(u._key, Pn.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = vh(t, this._firestore);
        return this._mutations = this._mutations.concat(new Jn(e._key, Pn.none())), this;
    }, 
    /**
 ...
 */ var yh, mh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = vh(t, this._firestore), i = new Zl(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new Ql(n._firestore, i, r._key, t._document, new jl(
            /* hasPendingWrites= */ !1, 
    ...
    return t.prototype.get = function(t) {
        var e = this, n = vh(t, this._firestore), r = new Kl(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return q();
            var i = t[0];
            if (i.isFoundDocument()) return new gl(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new gl(e._firestore, r, n._key, null, n.converter);
            throw q();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = vh(t, this._firestore), i = Gl(r.converter, e, n), o = $c(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = v(e)) || e instanceof Gc ? sl(this._dataReader, "Transaction.update", u._key, e, n, r) : ul(this._dataReader, "Transaction.update", u._key, e), 
 ...
 */ function gh(t, r, i) {
    t = Ua(t, Dc);
    var o = Object.assign(Object.assign({}, dh), i);
    return function(t) {
            ...
            return e(o, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), new sc(t.asyncQueue, e, i, r, u).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), u.promise;
    ...
    var s = function(t) {
        var e = "string" == typeof t ? function(t) {
            ...
            try {
                ...
                throw new j(K.INVALID_ARGUMENT, "Failed to parse JSON: " + (null === (e = t) || void 0 === e ? void 0 : e.message));
            }
        }(t) : t, n = [];
 ...
 */ void 0 === yh && (yh = !0), k = i, o(new c("firestore", (function(t, e) {
    var n = e.instanceIdentifier, r = e.options, i = t.getProvider("app").getImmediate(), o = new Dc(new Y(t.getProvider("auth-internal")), new $(t.getProvider("app-check-internal")), function(t, e) {
