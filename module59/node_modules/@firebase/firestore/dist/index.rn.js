    ...
    start(t, e) {
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                x("FirebaseAuthCredentialsProvider", "Auth not yet detected"), i.resolve(), i = new q);
            }
        }), 0), r();
    }
    getToken() {
...
class st {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new U(L.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new U(L.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new U(L.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new U(L.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ class ot extends rt {
     ...
     */    static fromString(...t) {
        ...
        const e = [];
        for (const n of t) {
            if (n.indexOf("//") >= 0) throw new U(L.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
 ...
 */ class ct extends rt {
     ...
     */    static fromServerFormat(t) {
        ...
        let n = "", s = 0;
        const i = () => {
            if (0 === n.length) throw new U(L.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(n), n = "";
        };
        let r = !1;
        for (;s < t.length; ) {
            const e = t[s];
            if ("\\" === e) {
                if (s + 1 === t.length) throw new U(L.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                const e = t[s + 1];
                if ("\\" !== e && "." !== e && "`" !== e) throw new U(L.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                n += e, s += 2;
            } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
        }
        if (i(), r) throw new U(L.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new ct(e);
    }
    static emptyPath() {
        return new ct([]);
     ...
     */    async F(t) {
        return this.db || (x("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new U(L.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s.name ? n(new U(L.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s)) : n(new Vt(t, s));
            }, s.onupgradeneeded = t => {
 ...
 */ class vt {
     ...
     */    delete() {
        return Ct(this.U.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Vt extends U {
    constructor(t, e) {
...
class kt {
    ...
    nt(t) {
        x("IndexBackiller", `Scheduled in ${t}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill" /* IndexBackfill */ , t, (async () => {
            this.task = null;
            try {
...
class Lt {
    constructor(t, e) {
        this.comparator = t, this.root = e || qt.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
    insert(t, e) {
        return new Lt(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, qt.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new Lt(this.comparator, this.root.remove(t, this.comparator).copy(null, null, qt.BLACK, null, null));
    }
    ...
    getIterator() {
        return new Ut(this.root, null, this.comparator, !1);
    }
    getIteratorFrom(t) {
        return new Ut(this.root, t, this.comparator, !1);
    }
    getReverseIterator() {
        return new Ut(this.root, null, this.comparator, !0);
    }
    getReverseIteratorFrom(t) {
        return new Ut(this.root, t, this.comparator, !0);
    }
}
...
class qt {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : qt.RED, this.left = null != s ? s : qt.EMPTY, 
        this.right = null != i ? i : qt.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new qt(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
...
class Kt {
    ...
    copy(t) {
        const e = new Kt(this.comparator);
        return e.data = t, e;
    }
}
...
class ie {
    ...
    isEqual(t) {
        return t instanceof ie && t.projectId === this.projectId && t.database === this.database;
    }
}
...
/** Returns whether the value represents -0. */ function oe(t) {
 ...
 */ function ue(t) {
    return "number" == typeof t && Number.isInteger(t) && !oe(t) && t <= Number.MAX_SAFE_INTEGER && t >= Number.MIN_SAFE_INTEGER;
}
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                const n = Xt(t.doubleValue), s = Xt(e.doubleValue);
                return n === s ? oe(n) === oe(s) : isNaN(n) && isNaN(s);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return et(t.arrayValue.values || [], e.arrayValue.values || [], le);
...
function de(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            const n = Xt(t.integerValue || t.doubleValue), s = Xt(e.integerValue || e.doubleValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = tt(Xt(t.latitude), Xt(e.latitude));
            if (0 !== n) return n;
            return tt(Xt(t.longitude), Xt(e.longitude));
...
function _e(t, e) {
    ...
    const n = Yt(t), s = Yt(e), i = tt(n.seconds, s.seconds);
...
/** Creates a deep copy of `source`. */ function Ae(t) {
    ...
    if (t.mapValue) {
        ...
        return $t(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Ae(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
        ...
        for (let n = 0; n < (t.arrayValue.values || []).length; ++n) e.arrayValue.values[n] = Ae(t.arrayValue.values[n]);
        return e;
    }
    return Object.assign({}, t);
}

/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */ function Re(t) {
    return "__max__" === (((t.mapValue || {}).fields || {}).__type__ || {}).stringValue;
}

/** Returns the lowest value for the given value type (inclusive). */ function be(t) {
    return "nullValue" in t ? ae : "booleanValue" in t ? {
        booleanValue: !1
        ...
        bytesValue: ""
    } : "referenceValue" in t ? ge(ie.empty(), at.empty()) : "geoPointValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
...
/** Returns the largest value for the given value type (exclusive). */ function Pe(t) {
    return "nullValue" in t ? {
        ...
        bytesValue: ""
    } : "bytesValue" in t ? ge(ie.empty(), at.empty()) : "referenceValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
 ...
 */ class Se {
     ...
     */    set(t, e) {
        this.getFieldsMap(t.popLast())[t.lastSegment()] = Ae(e);
    }
    /**
     ...
     */    setAll(t) {
        ...
        t.forEach(((t, i) => {
            ...
            t ? n[i.lastSegment()] = Ae(t) : s.push(i.lastSegment());
        }));
     ...
     */    delete(t) {
        ...
        Ee(e) && e.mapValue.fields && delete e.mapValue.fields[t.lastSegment()];
    }
    isEqual(t) {
 ...
 */ class Ce {
     ...
     */    static newInvalidDocument(t) {
        return new Ce(t, 0 /* INVALID */ , it.min(), it.min(), Se.empty(), 0 /* SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n) {
        return new Ce(t, 1 /* FOUND_DOCUMENT */ , e, it.min(), n, 0 /* SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new Ce(t, 2 /* NO_DOCUMENT */ , e, it.min(), Se.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new Ce(t, 3 /* UNKNOWN_DOCUMENT */ , e, it.min(), Se.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
     ...
     */    convertToNoDocument(t) {
        return this.version = t, this.documentType = 2 /* NO_DOCUMENT */ , this.data = Se.empty(), 
        this.documentState = 0 /* SYNCED */ , this;
    }
    /**
     ...
     */    convertToUnknownDocument(t) {
        return this.version = t, this.documentType = 3 /* UNKNOWN_DOCUMENT */ , this.data = Se.empty(), 
    ...
    isEqual(t) {
        return t instanceof Ce && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.documentType === t.documentType && this.documentState === t.documentState && this.data.isEqual(t.data);
    }
    mutableCopy() {
        return new Ce(this.key, this.documentType, this.version, this.readTime, this.data.clone(), this.documentState);
    }
    toString() {
...
function ke(t) {
    ...
    if (null === e.ht) {
        ...
        null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map((t => {
            return (e = t).field.canonicalString() + e.op.toString() + we(e.value);
            var e;
        })).join(","), t += "|ob:", t += e.orderBy.map((t => function(t) {
            // TODO(b/29183165): Make this collision robust.
            return t.field.canonicalString() + t.dir;
        }(t))).join(","), re(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", 
...
function Oe(t) {
    ...
    t.filters.length > 0 && (e += `, filters: [${t.filters.map((t => {
        return `${(e = t).field.canonicalString()} ${e.op} ${we(e.value)}`;
        /** Returns a debug description for `filter`. */
        var e;
        /** Filter that matches on key fields (i.e. '__name__'). */    })).join(", ")}]`), 
    re(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map((t => function(t) {
        return `${t.field.canonicalString()} (${t.dir})`;
...
function Me(t, e) {
    ...
    var n, s;
    return t.collectionGroup === e.collectionGroup && (!!t.path.isEqual(e.path) && (!!tn(t.startAt, e.startAt) && tn(t.endAt, e.endAt)));
}
...
/** Returns the field filters that target the given field path. */ function $e(t, e) {
    return t.filters.filter((t => t instanceof Ue && t.field.isEqual(e)));
}
...
/** Returns the number of segments of a perfect index for this target. */ class Ue extends class {} {
    constructor(t, e, n) {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.lt(t, e, n) : new qe(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new je(t, n) : "in" /* IN */ === e ? new We(t, n) : "not-in" /* NOT_IN */ === e ? new ze(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new He(t, n) : new Ue(t, e, n);
    }
    static lt(t, e, n) {
        return "in" /* IN */ === e ? new Ke(t, n) : new Ge(t, n);
    }
    matches(t) {
        const e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.ft(de(e, this.value)) : null !== e && he(this.value) === he(e) && this.ft(de(e, this.value));
...
/** Filter that matches on key fields within an array. */ class Ke extends Ue {
    constructor(t, e) {
...
/** Filter that matches on key fields not present within an array. */ class Ge extends Ue {
    constructor(t, e) {
...
/** A Filter that implements the array-contains operator. */ class je extends Ue {
    constructor(t, e) {
        super(t, "array-contains" /* ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return pe(e) && fe(e.arrayValue, this.value);
    }
}

/** A Filter that implements the IN operator. */ class We extends Ue {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the array-contains-any operator. */ class He extends Ue {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return !(!pe(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => fe(this.value.arrayValue, t)));
    }
}
...
/** Creates a new Query instance with the options provided. */ function nn(t, e, n, s, i, r, o, u) {
    return new en(t, e, n, s, i, r, o, u);
}
 ...
 */ function an(t) {
    ...
    if (null === e._t) {
        ...
        t.isKeyField() || e._t.push(new Ye(t)), e._t.push(new Ye(ct.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
            ...
            if (!t) {
                ...
                e._t.push(new Ye(ct.keyField(), t));
            }
        }
    }
    return e._t;
 ...
 */ function hn(t) {
    const e = B(t);
    if (!e.wt) if ("F" /* First */ === e.limitType) e.wt = Ne(e.path, e.collectionGroup, an(e), e.filters, e.limit, e.startAt, e.endAt); else {
        // Flip the orderBy directions since we want the last results
        const t = [];
        for (const n of an(e)) {
            const e = "desc" /* DESCENDING */ === n.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            t.push(new Ye(n.field, e));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new Je(e.endAt.position, e.endAt.inclusive) : null, s = e.startAt ? new Je(e.startAt.position, e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
        e.wt = Ne(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.wt;
}

function ln(t, e, n) {
    return new en(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
}

function fn(t, e) {
    return Me(hn(t), hn(e)) && t.limitType === e.limitType;
}
...
function dn(t) {
    return `${ke(hn(t))}|lt:${t.limitType}`;
}

function _n(t) {
    return `Query(target=${Oe(hn(t))}; limitType=${t.limitType})`;
}
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ class En {
    constructor() {
 ...
 */ function An(t, e, n) {
    ...
    }(n, e) : t instanceof vn ? Vn(t, e) : t instanceof Sn ? Dn(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = bn(t, e), s = xn(n) + xn(t.yt);
        return ye(n) && ye(t.yt) ? In(s) : pn(t.It, s);
    }(t, e);
}
 ...
 */ function Rn(t, e, n) {
    ...
    // applications.
    return t instanceof vn ? Vn(t, e) : t instanceof Sn ? Dn(t, e) : n;
}
 ...
 */ function bn(t, e) {
    return t instanceof Cn ? ye(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class vn extends En {
    constructor(t) {
...
/** Transforms an array value via a remove operation. */ class Sn extends En {
    constructor(t) {
        super(), this.elements = t;
    }
}
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ class kn {
    constructor(t, e) {
...
function On(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof vn && e instanceof vn || t instanceof Sn && e instanceof Sn ? et(t.elements, e.elements, le) : t instanceof Cn && e instanceof Cn ? le(t.yt, e.yt) : t instanceof Pn && e instanceof Pn;
...
/** Returns true if the preconditions is valid for the given document. */ function $n(t, e) {
 ...
 */ function Ln(t, e) {
    ...
    // mask is null when sets or deletes are applied to the current document.
        if (null === e) return t.isNoDocument() ? new Jn(t.key, Fn.none()) : new Qn(t.key, t.data, Fn.none());
    {
        const n = t.data, s = Se.empty();
        let i = new Kt(ct.comparator);
        ...
        return new jn(t.key, s, new jt(i.toArray()), Fn.none());
    }
}
 ...
 */ function Un(t, e, n) {
    t instanceof Qn ? function(t, e, n) {
    ...
    }(t, e, n) : t instanceof jn ? function(t, e, n) {
        if (!$n(t.precondition, e)) 
        ...
        i.setAll(Wn(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function qn(t, e, n, s) {
    return t instanceof Qn ? function(t, e, n, s) {
        ...
        return n;
        const i = t.value.clone(), r = Hn(t.fieldTransforms, s, e);
 ...
 *    ignored.
 */ (t, e, n, s) : t instanceof jn ? function(t, e, n, s) {
        if (!$n(t.precondition, e)) return n;
        const i = Hn(t.fieldTransforms, s, e), r = e.data;
        if (r.setAll(Wn(t)), r.setAll(i), e.convertToFoundDocument(e.version, r).setHasLocalMutations(), 
        null === n) return null;
 ...
 */ (t, e, n, s) : function(t, e, n) {
        if ($n(t.precondition, e)) return e.convertToNoDocument(e.version).setHasLocalMutations(), 
        null;
        return n;
    }
    /**
 ...
 */ function Kn(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        const t = e.data.field(s.field), i = bn(s.transform, t || null);
        null != i && (null === n && (n = Se.empty()), n.set(s.field, i));
    }
    return n || null;
}
...
function Gn(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && et(t, e, ((t, e) => On(t, e)));
 ...
 */ function Hn(t, e, n) {
    ...
    for (const i of t) {
        ...
        s.set(i.field, An(t, r, e));
    }
    return s;
}

/** A mutation that deletes the document at the given key. */ class Jn extends Bn {
    constructor(t, e) {
 ...
 *     Code.UNKNOWN.
 */ (ts = Zn || (Zn = {}))[ts.OK = 0] = "OK", ts[ts.CANCELLED = 1] = "CANCELLED", 
ts[ts.UNKNOWN = 2] = "UNKNOWN", ts[ts.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
ts[ts.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", ts[ts.NOT_FOUND = 5] = "NOT_FOUND", 
ts[ts.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", ts[ts.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
ts[ts.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", ts[ts.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
ts[ts.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", ts[ts.ABORTED = 10] = "ABORTED", 
ts[ts.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", ts[ts.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
ts[ts.INTERNAL = 13] = "INTERNAL", ts[ts.UNAVAILABLE = 14] = "UNAVAILABLE", ts[ts.DATA_LOSS = 15] = "DATA_LOSS";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const is = new Lt(at.comparator);

function rs() {
    return is;
}

const os = new Lt(at.comparator);
...
const fs = new Lt(at.comparator);

const ds = new Kt(at.comparator);
...
/** Tracks the internal state of a Watch target. */ class Es {
    constructor() {
        /**
     ...
     */    xt() {
        ...
        })), new ys(this.Pt, this.vt, t, e, n);
    }
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */    Nt() {
        this.Vt = !1, this.bt = bs();
    }
    kt(t, e) {
...
class As {
     ...
     */    Yt(t) {
        ...
        if (s) {
            ...
            if (Fe(t)) if (0 === n) {
                ...
                this.jt(e, n, Ce.newNoDocument(n, it.min()));
            } else F(1 === n); else {
                this.Zt(e) !== n && (
     ...
     */    te(t) {
        ...
        this.Lt.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && Fe(i.target)) {
                    ...
                    null !== this.Ut.get(e) || this.ee(s, e) || this.jt(s, e, Ce.newNoDocument(e, t));
                }
        ...
        const s = new gs(t, e, this.Kt, this.Ut, n);
        return this.Ut = rs(), this.qt = Rs(), this.Kt = new Kt(tt), s;
    }
    /**
    ...
    zt(t) {
        let e = this.Lt.get(t);
        return e || (e = new Es, this.Lt.set(t, e)), e;
    }
    ne(t) {
        let e = this.qt.get(t);
        return e || (e = new Kt(tt), this.qt = this.qt.insert(t, e)), e;
    }
    /**
...
function Os(t, e) {
    return Ns(t.databaseId, e.path);
}

function Ms(t, e) {
    const n = ks(e);
    if (n.get(1) !== t.databaseId.projectId) throw new U(L.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new U(L.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new at(Ls(n));
}

function Fs(t, e) {
    return Ns(t.databaseId, e);
}
...
function $s(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? ot.emptyPath() : Ls(e);
}
...
function qs(t, e, n) {
    const s = Ms(t, e.name), i = xs(e.updateTime), r = new Se({
        mapValue: {
            fields: e.fields
        }
    }), o = Ce.newFoundDocument(s, i, r);
...
function Ks(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Ms(t, e.found.name), s = xs(e.found.updateTime), i = new Se({
            mapValue: {
                fields: e.found.fields
            }
        });
        return Ce.newFoundDocument(n, s, i);
    }(t, e) : "missing" in e ? function(t, e) {
        F(!!e.missing), F(!!e.readTime);
        const n = Ms(t, e.missing), s = xs(e.readTime);
        return Ce.newNoDocument(n, s);
    }(t, e) : M();
}
...
function Gs(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.gt ? (F(void 0 === e || "string" == typeof e), Ht.fromBase64String(e || "")) : (F(void 0 === e || e instanceof Uint8Array), 
            Ht.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, u = o && function(t) {
            const e = void 0 === t.code ? L.UNKNOWN : ns(t.code);
 ...
 */ (o);
        n = new Ts(s, i, r, u || null);
    } else if ("documentChange" in e) {
        e.documentChange;
        const s = e.documentChange;
        s.document, s.document.name, s.document.updateTime;
        const i = Ms(t, s.document.name), r = xs(s.document.updateTime), o = new Se({
            mapValue: {
                fields: s.document.fields
            }
        }), u = Ce.newFoundDocument(i, r, o), c = s.targetIds || [], a = s.removedTargetIds || [];
        n = new ps(c, a, u.key, u);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Ms(t, s.document), r = s.readTime ? xs(s.readTime) : it.min(), o = Ce.newNoDocument(i, r), u = s.removedTargetIds || [];
        n = new ps([], u, o.key, o);
        ...
        if (!("filter" in e)) return M();
        {
            ...
            const t = e.filter;
            t.targetId;
            const s = t.count || 0, i = new Xn(s), r = t.targetId;
            n = new Is(r, i);
        }
    }
    return n;
...
function Qs(t, e) {
    ...
    }; else if (e instanceof Jn) n = {
        delete: Os(t, e.key)
    }; else if (e instanceof jn) n = {
        update: Us(t, e.key, e.data),
        updateMask: ri(e.fieldMask)
    }; else {
        if (!(e instanceof Yn)) return M();
        n = {
            verify: Os(t, e.key)
        };
    }
...
function js(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Fn.updateTime(xs(t.updateTime)) : void 0 !== t.exists ? Fn.exists(t.exists) : Fn.none();
    }(e.currentDocument) : Fn.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) F("REQUEST_TIME" === e.setToServerValue), n = new Pn; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new vn(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new Sn(t);
        } else "increment" in e ? n = new Cn(t, e.increment) : M();
        const s = ct.fromServerFormat(e.fieldPath);
        return new kn(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Ms(t, e.update.name), r = new Se({
            mapValue: {
        ...
        if (e.updateMask) {
            const t = function(t) {
                ...
                return new jt(e.map((t => ct.fromServerFormat(t))));
            }(e.updateMask);
            return new jn(i, r, t, n, s);
        }
...
function Ws(t, e) {
    return t && t.length > 0 ? (F(void 0 !== e), t.map((t => function(t, e) {
        ...
        let n = t.updateTime ? xs(t.updateTime) : xs(e);
        ...
        n = xs(e)), new Mn(n, t.transformResults || []);
    }(t, e)))) : [];
}

function zs(t, e) {
    return {
        documents: [ Fs(t, e.path) ]
    };
}
...
function Hs(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Fs(t, s), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Fs(t, s.popLast()), n.structuredQuery.from = [ {
...
function Js(t) {
    ...
    n.limit && (u = function(t) {
        let e;
        return e = "object" == typeof t ? t.value : t, re(e) ? null : e;
    }(n.limit));
    let c = null;
    ...
    // visible for testing
    (n.endAt)), nn(e, i, o, r, u, "F" /* First */ , c, a);
}
...
function Xs(t) {
    return t ? void 0 !== t.unaryFilter ? [ ii(t) ] : void 0 !== t.fieldFilter ? [ si(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Xs(t))).reduce(((t, e) => t.concat(e))) : M() : [];
}
...
function si(t) {
    return Ue.create(ni(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function ii(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        const e = ni(t.unaryFilter.field);
        return Ue.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        const n = ni(t.unaryFilter.field);
        return Ue.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        const s = ni(t.unaryFilter.field);
        return Ue.create(s, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        const i = ni(t.unaryFilter.field);
...
function ui(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = ai(e)), e = ci(t.get(n), e);
    return ai(e);
}
 ...
 */ class Mi {
    ...
    keys() {
        return this.mutations.reduce(((t, e) => t.add(e.key)), _s());
    }
    isEqual(t) {
        return this.batchId === t.batchId && et(this.mutations, t.mutations, ((t, e) => Gn(t, e))) && et(this.baseMutations, t.baseMutations, ((t, e) => Gn(t, e)));
    }
}

/** The result of applying a mutation batch to the backend. */ class Fi {
    constructor(t, e, n, 
    /**
 ...
 */ class Bi {
    ...
    /** Creates a new target data instance with an updated sequence number. */    withSequenceNumber(t) {
        return new Bi(this.target, this.targetId, this.purpose, t, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    withResumeToken(t, e) {
        return new Bi(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    withLastLimboFreeSnapshotVersion(t) {
        return new Bi(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t, this.resumeToken);
    }
}
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ class Li {
    constructor(t) {
        this.re = t;
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function Ui(t, e) {
    ...
    if (e.document) n = qs(t.re, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
        const t = at.fromSegments(e.noDocument.path), s = Qi(e.noDocument.readTime);
        n = Ce.newNoDocument(t, s), e.hasCommittedMutations && n.setHasCommittedMutations();
    } else {
        if (!e.unknownDocument) return M();
        {
            const t = at.fromSegments(e.unknownDocument.path), s = Qi(e.unknownDocument.version);
            n = Ce.newUnknownDocument(t, s);
        }
    }
...
/** Encodes a document for storage locally. */ function qi(t, e) {
    ...
    if (e.isFoundDocument()) s.document = function(t, e) {
        return {
            ...
            updateTime: Ss(t, e.version.toTimestamp())
        };
    }(t.re, e); else if (e.isNoDocument()) s.noDocument = {
        path: n.path.toArray(),
        readTime: Gi(e.version)
    }; else {
...
function ji(t, e) {
    const n = (e.baseMutations || []).map((e => js(t.re, e)));
    ...
    const s = e.mutations.map((e => js(t.re, e))), i = st.fromMillis(e.localWriteTimeMs);
    return new Mi(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function Wi(t) {
    const e = Qi(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? Qi(t.lastLimboFreeSnapshotVersion) : it.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (F(1 === (i = t.query).documents.length), 
    s = hn(sn($s(i.documents[0])))) : s = function(t) {
        return hn(Js(t));
    }(t.query), new Bi(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, Ht.fromBase64String(t.resumeToken));
}

/** Encodes TargetData into a DbTarget for storage locally. */ function zi(t, e) {
    const n = Gi(e.snapshotVersion), s = Gi(e.lastLimboFreeSnapshotVersion);
    let i;
    i = Fe(e.target) ? zs(t.re, e.target) : Hs(t.re, e.target);
...
function Hi(t) {
    ...
    return "LAST" === t.limitType ? ln(e, e.limit, "L" /* Last */) : e;
}

/** Encodes a NamedQuery proto object to a NamedQuery model object. */
/** Encodes a DbDocumentOverlay object to an Overlay model object. */
function Ji(t, e) {
    return new $i(e.largestBatchId, js(t.re, e.overlayMutation));
}
...
function Xi(t, e, n, s) {
    return {
        ...
        uid: e.uid || "",
        sequenceNumber: n,
        readTime: Gi(s.readTime),
        documentKey: ui(s.documentKey.path),
 ...
 */ class Zi {
    ...
    saveNamedQuery(t, e) {
        return er(t).put(function(t) {
            return {
                name: t.name,
                readTime: Gi(xs(t.readTime)),
 ...
 */ class nr {
    ...
    getOverlay(t, e) {
        return sr(t).get(Yi(this.userId, e)).next((t => t ? Ji(this.It, t) : null));
    }
    getOverlays(t, e) {
        const n = as();
    ...
    removeOverlaysForBatchId(t, e, n) {
        ...
        // Get the set of unique collection paths.
                e.forEach((t => s.add(ui(t.getCollectionPath()))));
        const i = [];
        return s.forEach((e => {
            const s = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, n + 1 ], 
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            i.push(sr(t).Y("collectionPathOverlayIndex", s));
        })), Rt.waitFor(i);
    }
    getOverlaysForCollection(t, e, n) {
        const s = as(), i = ui(e), r = IDBKeyRange.bound([ this.userId, i, n ], [ this.userId, i, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return sr(t).W("collectionPathOverlayIndex", r).next((t => {
            for (const e of t) {
...
class ir {
    ...
    ae(t, e) {
        ...
        e.fe(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.le(e, 15), e.fe(Xt(t.integerValue)); else if ("doubleValue" in t) {
            const n = Xt(t.doubleValue);
            isNaN(n) ? this.le(e, 13) : (this.le(e, 15), oe(n) ? 
        ...
        e.me(Zt(t.bytesValue)), this.we(e); else if ("referenceValue" in t) this.ge(t.referenceValue, e); else if ("geoPointValue" in t) {
            const n = t.geoPointValue;
            this.le(e, 45), e.fe(n.latitude || 0), e.fe(n.longitude || 0);
        } else "mapValue" in t ? Re(t) ? this.le(e, Number.MAX_SAFE_INTEGER) : (this.ye(t.mapValue, e), 
        this.we(e)) : "arrayValue" in t ? (this.pe(t.arrayValue, e), this.we(e)) : M();
    }
    _e(t, e) {
 ...
 */ class hr {
    constructor() {
        this.Be = new ur, this.Le = new cr(this.Be), this.Ue = new ar(this.Be);
    }
    seed(t) {
        this.Be.seed(t);
    }
 ...
 * limitations under the License.
 */
/** Represents an index entry saved by the SDK in persisted storage. */ class lr {
    constructor(t, e, n, s) {
     ...
     */    Ke() {
        ...
        new lr(this.indexId, this.documentKey, this.arrayValue, n);
    }
}

function fr(t, e) {
    let n = t.indexId - e.indexId;
    return 0 !== n ? n : (n = dr(t.arrayValue, e.arrayValue), 0 !== n ? n : (n = dr(t.directionalValue, e.directionalValue), 
 ...
 */ class wr {
    ...
    addToCollectionParentIndex(t, e) {
        return this.Ye.add(e), Rt.resolve();
    }
    getCollectionParents(t, e) {
        return Rt.resolve(this.Ye.getEntries(e));
    }
    addFieldIndex(t, e) {
 ...
 */ class mr {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new Kt(ot.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new Kt(ot.comparator)).toArray();
    }
}
...
class yr {
    constructor(t, e) {
         ...
         */
        this.Ze = new ss((t => ke(t)), ((t, e) => Me(t, e))), this.uid = t.uid || "";
    }
    /**
    ...
    addFieldIndex(t, e) {
        ...
        if (e.indexState) {
            const n = Er(t);
            return i.next((t => {
                n.put(Xi(t, this.user, e.indexState.sequenceNumber, e.indexState.offset));
            }));
        }
        return i.next();
    }
    deleteFieldIndex(t, e) {
        const n = Tr(t), s = Er(t), i = Ir(t);
    ...
    getDocumentsMatchingTarget(t, e) {
        ...
        let s = !0;
        const i = new Map;
        return Rt.forEach(this.tn(e), (e => this.en(t, e).next((t => {
            s && (s = !!t), i.set(e, t);
        })))).next((() => {
            if (s) {
                let t = _s();
                ...
                return Rt.forEach(i, ((i, r) => {
                    var o;
                    x("IndexedDbIndexManager", `Using index ${o = i, `id=${o.indexId}|cg=${o.collectionGroup}|f=${o.fields.map((t => `${t.fieldPath}:${t.kind}`)).join(",")}`} to execute ${ke(e)}`);
                    const u = function(t, e) {
                        const n = lt(e);
                        if (void 0 === n) return null;
                        for (const e of $e(t, n.fieldPath)) switch (e.op) {
 ...
 */ (r, i), c = function(t, e) {
                        const n = new Map;
                        for (const s of ft(e)) for (const e of $e(t, s.fieldPath)) switch (e.op) {
                          case "==" /* EQUAL */ :
                          case "in" /* IN */ :
 ...
 */ (r, i), a = function(t, e) {
                        ...
                        // startAt.
                                                for (const i of ft(e)) {
                            const e = 0 /* ASCENDING */ === i.kind ? Be(t, i.fieldPath, t.startAt) : Le(t, i.fieldPath, t.startAt);
 ...
 */ (r, i), h = function(t, e) {
                        ...
                        // endAt.
                                                for (const i of ft(e)) {
                            const e = 0 /* ASCENDING */ === i.kind ? Le(t, i.fieldPath, t.endAt) : Be(t, i.fieldPath, t.endAt);
                            n.push(e.value), s && (s = e.inclusive);
                        }
                        return new Je(n, s);
     ...
     */    rn(t, e, n, s, i, r, o) {
        ...
        for (let h = 0; h < u; ++h) {
            const u = e ? this.on(e[h / c]) : gr, l = this.un(t, u, n[h % c], s), f = this.cn(t, u, i[h % c], r), d = o.map((e => this.un(t, u, e, 
            /* inclusive= */ !0)));
    ...
    en(t, e) {
        const n = new _r(e), s = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment();
    ...
    getIndexType(t, e) {
        ...
        return Rt.forEach(this.tn(e), (e => this.en(t, e).next((t => {
            t ? 0 /* NONE */ !== n && t.fields.length < function(t) {
                let e = new Kt(ct.comparator), n = !1;
    ...
    /** Encodes a single value to the ascending index format. */    on(t) {
        const e = new hr;
        return ir.Te.ce(t, e.qe(0 /* ASCENDING */)), e.$e();
    }
    /**
     ...
     */    hn(t, e) {
        const n = new hr;
        return ir.Te.ce(ge(this.databaseId, e), n.qe(function(t) {
            const e = ft(t);
     ...
     */    sn(t, e, n) {
        ...
        for (const r of ft(t)) {
            const t = n[i++];
            for (const n of s) if (this.ln(e, r.fieldPath) && pe(t)) s = this.fn(s, r, t); else {
                const e = n.qe(r.kind);
                ir.Te.ce(t, e);
            }
        }
     ...
     */    fn(t, e, n) {
        ...
        for (const t of n.arrayValue.values || []) for (const n of s) {
            const s = new hr;
            s.seed(n.$e()), ir.Te.ce(t, s.qe(e.kind)), i.push(s);
        }
        return i;
    }
    ln(t, e) {
        return !!t.filters.find((t => t instanceof Ue && t.field.isEqual(e) && ("in" /* IN */ === t.op || "not-in" /* NOT_IN */ === t.op)));
    }
    getFieldIndexes(t, e) {
        const n = Tr(t), s = Er(t);
        return (e ? n.W("collectionGroupIndex", IDBKeyRange.bound(e, e)) : n.W()).next((t => {
            ...
            return Rt.forEach(t, (t => s.get([ t.indexId, this.uid ]).next((n => {
                e.push(function(t, e) {
                    const n = e ? new mt(e.sequenceNumber, new pt(Qi(e.readTime), new at(hi(e.documentKey)), e.largestBatchId)) : mt.empty(), s = t.fields.map((([t, e]) => new _t(ct.fromServerFormat(t), e)));
    ...
    updateCollectionGroup(t, e, n) {
        const s = Tr(t), i = Er(t);
        return this._n(t).next((t => s.W("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((e => Rt.forEach(e, (e => i.put(Xi(e.indexId, this.user, t, n))))))));
    }
    updateIndexEntries(t, e) {
        ...
        return Rt.forEach(e, ((e, s) => {
            ...
            Rt.forEach(i, (n => this.wn(t, e, n).next((e => {
                const i = this.mn(s, n);
                return e.isEqual(i) ? Rt.resolve() : this.gn(t, s, n, e, i);
            })))))));
        }));
    }
    yn(t, e, n, s) {
    ...
    pn(t, e, n, s) {
        return Ir(t).delete([ s.indexId, this.uid, s.arrayValue, s.directionalValue, this.hn(n, e.key), e.key.path.toArray() ]);
    }
    wn(t, e, n) {
        const s = Ir(t);
        let i = new Kt(fr);
        return s.Z({
            ...
            i = i.add(new lr(n.indexId, e, s.arrayValue, s.directionalValue));
        })).next((() => i));
    }
    /** Creates the index entries for the given document. */    mn(t, e) {
        ...
        if (null != i) {
            ...
            if (pe(r)) for (const i of r.arrayValue.values || []) n = n.add(new lr(e.indexId, t.key, this.on(i), s));
        } else n = n.add(new lr(e.indexId, t.key, gr, s));
        return n;
    }
    /**
     ...
     */    gn(t, e, n, s, i) {
        ...
        return function(t, e, n, s, i) {
            ...
            for (;u || c; ) {
                ...
                t ? (s(c), c = Qt(o)) : e ? (i(u), u = Qt(r)) : (u = Qt(r), c = Qt(o));
            }
        }(s, i, fr, (
        /* onAdd= */ s => {
     ...
     */    createRange(t, e, n) {
        ...
        s.push(e);
        const i = [];
        for (let t = 0; t < s.length; t += 2) i.push(IDBKeyRange.bound([ s[t].indexId, this.uid, s[t].arrayValue, s[t].directionalValue, gr, [] ], [ s[t + 1].indexId, this.uid, s[t + 1].arrayValue, s[t + 1].directionalValue, gr, [] ]));
        return i;
    }
    getMinOffsetFromCollectionGroup(t, e) {
        return this.getFieldIndexes(t, e).next(Ar);
    }
    getMinOffset(t, e) {
        return Rt.mapArray(this.tn(e), (e => this.en(t, e).next((t => t || M())))).next(Ar);
    }
}
...
class br {
    ...
    static withCacheSize(t) {
        return new br(t, br.DEFAULT_COLLECTION_PERCENTILE, br.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
    }
}
...
function Pr(t, e, n) {
    ...
    for (const t of n.mutations) {
        const s = di(e, t.key.path, n.batchId);
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ br.DEFAULT_COLLECTION_PERCENTILE = 10, 
br.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, br.DEFAULT = new br(41943040, br.DEFAULT_COLLECTION_PERCENTILE, br.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
...
class Vr {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            F("number" == typeof o);
            const u = new Mi(o, e, n, s), c = function(t, e, n) {
            ...
            let h = new Kt(((t, e) => tt(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
                const e = di(this.userId, t.key.path, o);
                h = h.add(t.key.path.popLast()), a.push(r.put(c)), a.push(i.put(e, _i));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return Dr(t).get(e).next((t => t ? (F(t.userId === this.userId), ji(this.It, t)) : null));
    }
    /**
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Dr(t).Z({
            ...
            e.userId === this.userId && (F(e.batchId >= n), i = ji(this.It, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return Dr(t).W("userMutationsIndex", e).next((t => t.map((t => ji(this.It, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = fi(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return Cr(t).Z({
            range: s
        }, ((n, s, r) => {
            const [o, u, c] = n, a = hi(u);
            ...
            return Dr(t).get(c).next((t => {
                if (!t) throw M();
                F(t.userId === this.userId), i.push(ji(this.It, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = fi(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Cr(t).Z({
                range: r
            }, ((t, s, i) => {
                const [r, o, u] = t, c = hi(o);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
    ...
    getAllMutationBatchesAffectingQuery(t, e) {
        const n = e.path, s = n.length + 1, i = fi(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    En(t, e) {
        ...
        return e.forEach((e => {
            s.push(Dr(t).get(e).next((t => {
                if (null === t) throw M();
                F(t.userId === this.userId), n.push(ji(this.It, t));
            })));
        })), Rt.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return Pr(t.ie, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.An(e.batchId);
 ...
 */ function Sr(t, e, n) {
    const s = fi(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return Cr(t).Z({
        range: r,
        X: !0
 ...
 */ class kr {
    ...
    allocateTargetId(t) {
        return this.Vn(t).next((e => {
            const n = new Nr(e.highestTargetId);
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => Or(t).delete(e.targetId))).next((() => this.Vn(t))).next((e => (F(e.targetCount > 0), 
    ...
    Vn(t) {
        return Mr(t).get("targetGlobalKey").next((t => (F(null !== t), t)));
    }
    Sn(t, e) {
        return Mr(t).put("targetGlobalKey", e);
    }
    Dn(t, e) {
        return Or(t).put(zi(this.It, e));
    }
    /**
    ...
    getTargetData(t, e) {
        ...
        const n = ke(e), s = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]);
        let i = null;
        return Or(t).Z({
            range: s,
    ...
    removeMatchingKeysForTargetId(t, e) {
        const n = Fr(t), s = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(s);
    }
    getMatchingKeysForTargetId(t, e) {
        ...
        return s.Z({
            ...
            const s = hi(t[1]), r = new at(s);
            i = i.add(r);
        })).next((() => i));
    }
    containsKey(t, e) {
        const n = ui(e.path), s = IDBKeyRange.bound([ n ], [ nt(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Fr(t).Z({
    ...
    // PORTING NOTE: Multi-tab only.
    se(t, e) {
        return Or(t).get(e).next((t => t ? Wi(t) : null));
    }
}
 ...
 */ class Br {
    constructor(t) {
        this.xn = t, this.buffer = new Kt($r), this.Nn = 0;
    }
    kn() {
        return ++this.Nn;
    }
    On(t) {
        ...
        if (this.buffer.size < this.xn) this.buffer = this.buffer.add(e); else {
            ...
            $r(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
 ...
 */ class Lr {
    ...
    Fn(t) {
        x("LruGarbageCollector", `Garbage collection scheduled in ${t}ms`), this.Mn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , t, (async () => {
            this.Mn = null;
            try {
...
/** Implements the steps for LRU garbage collection. */ class Ur {
    constructor(t, e) {
    ...
    collect(t, e) {
        ...
        Rt.resolve(Rr)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (x("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        Rr) : this.Un(t, e)));
    }
    getCacheSize(t) {
...
class qr {
     ...
     */    Gn(t, e) {
        return function(t, e) {
            let n = !1;
            return xr(t).tt((s => Sr(t, s, e).next((t => (t && (n = !0), Rt.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.Kn(t, ((r, o) => {
            if (o <= e) {
                const e = this.Gn(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r, it.min()), Fr(t).delete([ 0, ui(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ class Gr {
     ...
     * `getEntry()/getEntries()` (enforced via IndexedDbs `apply()`).
     */    removeEntry(t, e) {
        this.assertNotApplied(), this.changes.set(t, Ce.newInvalidDocument(t).setReadTime(e));
    }
    /**
 ...
 */ (e, n));
     ...
     */    Wn(t, e) {
        let n = {
            size: 0,
            document: Ce.newInvalidDocument(e)
        };
        return Hr(t).Z({
            index: "documentKeyIndex",
            range: IDBKeyRange.only(Jr(e))
     ...
     */    Hn(t, e) {
        let n = rs(), s = new Lt(at.comparator);
        return this.zn(t, e, ((t, e) => {
            const i = this.jn(t, e);
    ...
    zn(t, e, n) {
        ...
        return Hr(t).Z({
            ...
            // Go through keys not found in cache.
                        for (;o && Xr(o, i) < 0; ) n(o, null), o = r.getNext();
            o && o.isEqual(i) && (
            // Key found in cache.
    ...
    getAllFromCollection(t, e, n) {
        ...
        return Hr(t).W(IDBKeyRange.bound(s, i, !0)).next((t => {
            let e = rs();
            for (const n of t) {
    ...
    newChangeBuffer(t) {
        return new Wr(this, !!t && t.trackRemovals);
    }
    getSize(t) {
        return this.getMetadata(t).next((t => t.byteSize));
    }
    getMetadata(t) {
        return zr(t).get("remoteDocumentGlobalKey").next((t => (F(!!t), t)));
    }
    Qn(t, e) {
     ...
     */    jn(t, e) {
        if (e) {
            const t = Ui(this.It, e);
            // Whether the document is a sentinel removal and should only be used in the
            // `getNewDocumentChanges()`
                        if (!(t.isNoDocument() && t.version.isEqual(it.min()))) return t;
        }
        return Ce.newInvalidDocument(t);
    }
}

/** Creates a new IndexedDbRemoteDocumentCache. */ function jr(t) {
    return new Qr(t);
}
 ...
 */ class Wr extends Gr {
    ...
    constructor(t, e) {
        ...
        // this buffer.
        this.Xn = new ss((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        let n = 0, s = new Kt(((t, e) => tt(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            ...
            if (e.push(this.Yn.removeEntry(t, i, o.readTime)), r.isValidDocument()) {
                ...
                const n = qi(this.Yn.It, r.convertToNoDocument(it.min()));
 ...
 */ class to {
     ...
     */    getDocument(t, e) {
        let n = null;
        return this.documentOverlayCache.getOverlay(t, e).next((s => (n = s, this.getBaseDocument(t, e, n)))).next((t => (null !== n && qn(n.mutation, t, jt.empty(), st.now()), 
        t)));
    }
    /**
     ...
     */    getDocuments(t, e) {
        return this.remoteDocumentCache.getEntries(t, e).next((e => this.getLocalViewOfDocuments(t, e, _s()).next((() => e))));
    }
    /**
     ...
     *   to be recalculated.
     */    getLocalViewOfDocuments(t, e, n = _s()) {
        const s = as();
     ...
     */    getOverlayedDocuments(t, e) {
        const n = as();
        return this.populateOverlays(t, n, e).next((() => this.computeViews(t, e, n, _s())));
    }
    /**
     ...
     */    computeViews(t, e, n, s) {
        ...
        return e.forEach(((t, e) => {
            ...
            // change (hence overlay is undefined), but would now match.
                        s.has(e.key) && (void 0 === o || o.mutation instanceof jn) ? i = i.insert(e.key, e) : void 0 !== o && (r.set(e.key, o.mutation.getFieldMask()), 
            qn(o.mutation, e, o.mutation.getFieldMask(), st.now()));
        })), this.recalculateAndSaveOverlays(t, i).next((t => (t.forEach(((t, e) => r.set(t, e))), 
        e.forEach(((t, e) => {
            var n;
            return o.set(t, new Zr(e, null !== (n = r.get(t)) && void 0 !== n ? n : null));
        })), o)));
    }
    recalculateAndSaveOverlays(t, e) {
        const n = ls();
        // A reverse lookup map from batch id to the documents within that batch.
                let s = new Lt(((t, e) => t - e)), i = _s();
        return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t, e).next((t => {
            for (const i of t) i.keys().forEach((t => {
                ...
                const u = (s.get(i.batchId) || _s()).add(t);
 ...
 */
     ...
     */    getNextDocuments(t, e, n, s) {
        return this.remoteDocumentCache.getAllFromCollectionGroup(t, e, n, s).next((i => {
            const r = s - i.size > 0 ? this.documentOverlayCache.getOverlaysForCollectionGroup(t, e, n.largestBatchId, s - i.size) : Rt.resolve(as());
            ...
            i.get(e) ? Rt.resolve() : this.getBaseDocument(t, e, n).next((t => {
                u = u.insert(e, t);
            }))))).next((() => this.populateOverlays(t, e, i))).next((() => this.computeViews(t, u, e, _s()))).next((t => ({
                batchId: o,
                changes: cs(t)
            })))));
        }));
    ...
    getDocumentsMatchingCollectionQuery(t, e, n) {
        ...
        this.documentOverlayCache.getOverlaysForCollection(t, e.path, n.largestBatchId)))).next((t => {
            ...
            t.forEach(((t, e) => {
                const n = e.getKey();
                null === s.get(n) && (s = s.insert(n, Ce.newInvalidDocument(n)));
            }));
            // Apply the overlays and match against the query.
            let n = us();
            return s.forEach(((s, i) => {
                const r = t.get(s);
                void 0 !== r && qn(r.mutation, i, jt.empty(), st.now()), 
                // Finally, insert the documents that still match the query
                wn(e, i) && (n = n.insert(s, i));
            })), n;
        }));
    }
    /** Returns a base document that can be used to apply `overlay`. */    getBaseDocument(t, e, n) {
        return null === n || 1 /* Patch */ === n.mutation.type ? this.remoteDocumentCache.getEntry(t, e) : Rt.resolve(Ce.newInvalidDocument(e));
    }
}
 ...
 */ class no {
    constructor() {
        ...
        this.overlays = new Lt(at.comparator), this.es = new Map;
    }
    getOverlay(t, e) {
    ...
    getOverlaysForCollection(t, e, n) {
        const s = as(), i = e.length + 1, r = new at(e.child("")), o = this.overlays.getIteratorFrom(r);
        for (;o.hasNext(); ) {
    ...
    ue(t, e, n) {
        ...
        this.overlays = this.overlays.insert(n.key, new $i(e, n));
        // Create the association of this overlay to the given largestBatchId.
        let i = this.es.get(e);
        void 0 === i && (i = _s(), this.es.set(e, i)), this.es.set(e, i.add(n.key));
    }
}
 ...
 */ class so {
    constructor() {
        ...
        this.ns = new Kt(io.ss), 
        // A set of outstanding references to a document sorted by target id.
        this.rs = new Kt(io.os);
    }
     ...
     * removed.
     */    ls(t) {
        const e = new at(new ot([])), n = new io(e, t), s = new io(e, t + 1), i = [];
    ...
    ds(t) {
        const e = new at(new ot([])), n = new io(e, t), s = new io(e, t + 1);
        let i = _s();
        return this.rs.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new io(t, 0), n = this.ns.firstAfterOrEqual(e);
 ...
 */ class ro {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        for (const e of s) this.gs = this.gs.add(new io(e.key, i)), this.indexManager.addToCollectionParentIndex(t, e.key.path.popLast());
        return Rt.resolve(r);
    }
    lookupMutationBatch(t, e) {
    ...
    containsKey(t, e) {
        const n = new io(e, 0), s = this.gs.firstAfterOrEqual(n);
...
class oo {
    ...
    constructor(t) {
        ...
        this.docs = new Lt(at.comparator), 
    ...
    getEntry(t, e) {
        ...
        return Rt.resolve(n ? n.document.mutableCopy() : Ce.newInvalidDocument(e));
    }
    getEntries(t, e) {
        let n = rs();
        return e.forEach((t => {
            const e = this.docs.get(t);
            n = n.insert(t, e ? e.document.mutableCopy() : Ce.newInvalidDocument(t));
        })), Rt.resolve(n);
    }
    getAllFromCollection(t, e, n) {
        let s = rs();
 ...
 */ class co {
    constructor(t) {
         ...
         * IDs.
         */
        this.Ps = new so, this.targetCount = 0, this.vs = Nr.Pn();
    }
    forEachTarget(t, e) {
    ...
    Dn(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.vs = new Nr(e), this.highestTargetId = e), t.sequenceNumber > this.bs && (this.bs = t.sequenceNumber);
    }
    addTargetData(t, e) {
...
class ao {
    ...
    constructor(t, e) {
        ...
        this.referenceDelegate = t(this), this.Cs = new co(this);
        this.indexManager = new wr, this.remoteDocumentCache = function(t) {
            return new oo(t);
        }((t => this.referenceDelegate.xs(t))), this.It = new Li(e), this.Ns = new eo(this.It);
    }
    start() {
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ class fo {
    constructor(t) {
        this.It = t;
    }
    /**
     ...
     */    $(t, e, n, s) {
        ...
        n < 1 && s >= 1 && (function(t) {
            ...
            t.createObjectStore("mutations", {
                keyPath: "batchId",
                autoIncrement: !0
            }).createIndex("userMutationsIndex", li, {
                unique: !0
 ...
 */
        ...
        n < 9 && s >= 9 && (r = r.next((() => {
            ...
            !function(t) {
                ...
                e.createIndex("collectionPathOverlayIndex", vi, {
                    unique: !1
                }), e.createIndex("collectionGroupOverlayIndex", Vi, {
                    unique: !1
                });
            }(t);
        ...
        n < 14 && s >= 14 && (r = r.next((() => this.zs(t, i)))), n < 15 && s >= 15 && (r = r.next((() => function(t) {
            ...
            t.createObjectStore("indexEntries", {
                keyPath: Ri
            }).createIndex("documentKeyIndex", bi, {
                unique: !1
            });
        }(t)))), r;
    }
 ...
 */            const u = {
    ...
    zs(t, e) {
        const n = e.store("mutations"), s = jr(this.It), i = new ao(lo.Bs, this.It.re);
        return n.W().next((t => {
            const n = new Map;
            return t.forEach((t => {
                var e;
                let s = null !== (e = n.get(t.userId)) && void 0 !== e ? e : _s();
                ji(this.It, t).keys().forEach((t => s = s.add(t))), n.set(t.userId, s);
            })), Rt.forEach(n, ((t, n) => {
                const r = new v(n), o = nr.oe(this.It, r), u = i.getIndexManager(r), c = Vr.oe(r, this.It, u, i.referenceDelegate);
                return new to(s, c, o, u).recalculateAndSaveOverlaysForDocumentKeys(new ki(e, Mt.at), t).next();
            }));
        }));
    }
}
...
const wo = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
...
class mo {
    ...
    a, h = 15) {
        ...
        this.si = t => Promise.resolve(), !mo.C()) throw new U(L.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new qr(this, s), this.ii = e + "main", this.It = new Li(u), 
        this.ri = new Pt(this.ii, this.Xs, new fo(this.It)), this.Cs = new kr(this.referenceDelegate, this.It), 
        this.remoteDocumentCache = jr(this.It), this.Ns = new Zi, this.window && this.window.localStorage ? this.oi = this.window.localStorage : (this.oi = null, 
     ...
     */    start() {
        ...
        return this.ui().then((() => {
            ...
            throw new U(L.FAILED_PRECONDITION, wo);
     ...
     * primary lease.
     */    ui() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => yo(t).put({
        ...
        return go(t).get("owner").next((t => Rt.resolve(this.mi(t))));
    }
    gi(t) {
     ...
     */    di(t) {
        ...
        return go(t).get("owner").next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || yo(t).W().next((t => void 0 === this.Ii(t, 5e3).find((t => {
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    vi() {
        return this.runTransaction("getActiveClients", "readonly", (t => yo(t).W().next((t => this.Ii(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.Ds;
    }
    getMutationQueue(t, e) {
        return Vr.oe(t, this.It, e, this.referenceDelegate);
    }
    getTargetCache() {
        return this.Cs;
    }
    ...
    getIndexManager(t) {
        return new yr(t, this.It.re.databaseId);
    }
    getDocumentOverlayCache(t) {
        return nr.oe(this.It, t);
    }
    getBundleCache() {
        return this.Ns;
    }
    runTransaction(t, e, n) {
        ...
        const s = "readonly" === e ? "readonly" : "readwrite", i = 15 === (r = this.Xs) ? Ni : 14 === r ? xi : 13 === r ? Ci : 12 === r ? Di : 11 === r ? Si : void M();
        /** Returns the object stores for the provided schema. */
        var r;
        let o;
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
                return this.ri.runTransaction(t, s, i, (s => (o = new ki(s, this.Ss ? this.Ss.next() : Mt.at), 
        "readwrite-primary" === e ? this.fi(o).next((t => !!t || this.di(o))).next((e => {
            ...
            this.Hs.enqueueRetryable((() => this.si(!1))), new U(L.FAILED_PRECONDITION, Tt);
            return n(o);
    ...
    // be turned off.
    Vi(t) {
        return go(t).get("owner").next((t => {
            if (null !== t && this.pi(t.leaseTimestampMs, 5e3) && !this.Ei(t.ownerId) && !this.mi(t) && !(this.Ys || this.allowTabSynchronization && t.allowTabSynchronization)) throw new U(L.FAILED_PRECONDITION, wo);
        }));
    }
    /**
...
class Io {
 ...
 // do nothing
        ...
        return new Io(t, e.fromCache, n, s);
    }
}
 ...
 */ class To {
     ...
     */    ki(t, e) {
        ...
        e = ln(e, null, "F" /* First */), n = hn(e)), this.indexManager.getDocumentsMatchingTarget(t, n).next((s => {
            const i = _s(...s);
            return this.Ni.getDocuments(t, i).next((s => this.indexManager.getMinOffset(t, n).next((n => {
                const r = this.Fi(e, s);
                return this.$i(e, r, i, n.readTime) ? this.ki(t, ln(e, null, "F" /* First */)) : this.Bi(t, r, e, n);
            }))));
        })))));
    }
    /**
     ...
     */    Oi(t, e, n, s) {
        return rn(e) || s.isEqual(it.min()) ? this.Mi(t, e) : this.Ni.getDocuments(t, n).next((i => {
            const r = this.Fi(e, i);
            return this.$i(e, r, n, s) ? this.Mi(t, e) : (D() <= u.DEBUG && x("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), _n(e)), 
    ...
    Mi(t, e) {
        return D() <= u.DEBUG && x("QueryEngine", "Using full collection scan to execute query:", _n(e)), 
 ...
 */ function vo(t, e) {
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (t => {
        ...
        e.targetChanges.forEach(((r, u) => {
            ...
            e.targetMismatches.has(u) ? a = a.withResumeToken(Ht.EMPTY_BYTE_STRING, it.min()).withLastLimboFreeSnapshotVersion(it.min()) : r.resumeToken.approximateByteSize() > 0 && (a = a.withResumeToken(r.resumeToken, s)), 
            i = i.insert(u, a), 
 ...
 */ (c, a, r) && o.push(n.Cs.updateTargetData(t, a));
        ...
        o.push(Vo(t, r, e.documentUpdates).next((t => {
            u = t.Wi, c = t.zi;
        }))), !s.isEqual(it.min())) {
...
function Do(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, Rt.resolve(s)) : n.Cs.allocateTargetId(t).next((i => (s = new Bi(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
...
async function Co(t, e, n) {
    const s = B(t), i = s.Ui.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
 ...
 */ function xo(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = B(t), i = s.qi.get(n);
        return void 0 !== i ? Rt.resolve(s.Ui.get(i)) : s.Cs.getTargetData(e, n);
    }(s, t, hn(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.Cs.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.Li.getDocumentsMatchingQuery(t, e, n ? i : it.min(), n ? r : _s()))).next((t => (Oo(s, mn(e), t), 
    {
        documents: t,
        Hi: r
    })))));
...
// PORTING NOTE: Multi-Tab only.
function No(t, e) {
    const n = B(t), s = B(n.Cs), i = n.Ui.get(e);
...
function ko(t, e) {
    ...
    /* limit= */ Number.MAX_SAFE_INTEGER))).then((t => (Oo(n, e, t), t)));
}
...
async function Mo(t, e, n, s) {
    ...
    const u = i.Gi.newChangeBuffer({
        trackRemovals: !0
    }), c = await Do(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return hn(sn(ot.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => Vo(t, u, o).next((e => (u.apply(t), 
 ...
 */
async function Fo(t, e, n = _s()) {
    // Allocate a target for the named query such that it can be resumed
    // from associated read time if users use it to listen.
    // NOTE: this also means if no corresponding target exists, the new target
    // will remain active and will not get collected, unless users happen to
    // unlisten the query somehow.
    const s = await Do(t, hn(Hi(e.bundledQuery))), i = B(t);
    return i.persistence.runTransaction("Save named query", "readwrite", (t => {
        const r = xs(e.readTime);
...
class Uo {
     ...
     */    static Zi(t, e, n) {
        ...
        r && (i = new U(s.error.code, s.error.message))), r ? new Uo(t, e, s.state, i) : (N("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    tr() {
        const t = {
...
class qo {
     ...
     */    static Zi(t, e) {
        ...
        i && (s = new U(n.error.code, n.error.message))), i ? new qo(t, n.state, s) : (N("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    tr() {
        const t = {
 ...
 */ class Ko {
     ...
     */    static Zi(t, e) {
        ...
        for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = ue(n.activeTargetIds[t]), 
        i = i.add(n.activeTargetIds[t]);
        return s ? new Ko(t, i) : (N("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Go {
     ...
     */    static Zi(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Go(e.clientId, e.onlineState) : (N("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class jo {
    constructor(t, e, n, s, i) {
        ...
        this.ur = new Lt(tt), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.ar = $o(this.persistenceKey, this.sr), 
        this.hr = 
 ...
 */ (this.persistenceKey), this.ur = this.ur.insert(this.sr, new Qo), this.lr = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    async start() {
        ...
        for (const e of t) {
            ...
            const t = this.getItem($o(this.persistenceKey, e));
            if (t) {
                const n = Ko.Zi(e, t);
    ...
    addLocalQueryTarget(t) {
        ...
        // by another tab
            ...
            const n = this.storage.getItem(Lo(this.persistenceKey, t));
            if (n) {
                const s = qo.Zi(t, n);
                s && (e = s.state);
            }
 ...
 */ (e.newValue);
    ...
    Tr(t, e, n) {
        const s = new Uo(this.currentUser, t, e, n), i = Bo(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.tr());
    }
    Er(t) {
        const e = Bo(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    }
    br(t) {
        const e = {
    ...
    Rr(t, e, n) {
        const s = Lo(this.persistenceKey, t), i = new qo(t, e, n);
        this.setItem(s, i.tr());
    }
    Pr(t) {
...
class {
            ...
            o.setWithCredentials(!0), o.listenOnce(y.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case p.TIMEOUT:
                        x("Connection", 'RPC "' + t + '" timed out'), r(new U(L.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case p.HTTP_ERROR:
                        ...
                        r(new U(L.UNAVAILABLE, "Connection failed."));
                        break;
    ...
    wo(t, e, n) {
        ...
        // enough the code is exception free.
            ...
            h || (h = !0, k("Connection", "WebChannel transport errored:", t), l.io(new U(L.UNAVAILABLE, "The operation could not be completed")));
...
/** The Platform's 'document' implementation or null if not available. */ function tu() {
 ...
 * limitations under the License.
 */ function eu(t) {
    return new Vs(t, /* useProto3Json= */ !0);
}
...
class su {
    ...
    jo(t) {
        ...
        return x("PersistentStream", `close with error: ${t}`), this.stream = null, this.close(4 /* Error */ , t);
    }
    /**
     ...
     */    Ho(t) {
        ...
        e.database = Bs(this.It), e.addTarget = function(t, e) {
            ...
            return n = Fe(s) ? {
                ...
                query: Hs(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Ds(t, e.resumeToken) : e.snapshotVersion.compareTo(it.min()) > 0 && (
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                const s = new Bi(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                _u(t, s);
            })), t.remoteSyncer.applyRemoteEvent(n);
        }(t, n);
    } catch (e) {
        x("RemoteStore", "Failed to raise snapshot:", e), await Au(t, e);
    }
}
...
class $u {
     ...
     */    cancel(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new U(L.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    handleDelayElapsed() {
 ...
 */ function Bu(t, e) {
    if (N("AsyncQueue", `${e}: ${t}`), St(t)) return new U(L.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Lu {
    ...
    constructor(t) {
        ...
        this.keyedMap = us(), this.sortedSet = new Lt(this.comparator);
    }
    /**
 ...
 */ class Xu {
     ...
     */    Yi(t) {
        return t.metadata.exists ? qs(this.It, t.document, !1) : Ce.newNoDocument(this.Ji(t.metadata.name), this.Xi(t.metadata.readTime));
    }
    Xi(t) {
        return xs(t);
    }
 ...
 */ class Zu {
    ...
    $u(t) {
        const e = new Map, n = new Xu(this.It);
        for (const s of t) if (s.metadata.queries) {
            const t = n.Ji(s.metadata.name);
            for (const n of s.metadata.queries) {
                const s = (e.get(n) || _s()).add(t);
                e.set(n, s);
            }
        }
        return e;
     ...
     */    async complete() {
        const t = await Mo(this.localStore, new Xu(this.It), this.documents, this.Mu.id), e = this.$u(this.documents);
        for (const t of this.queries) await Fo(this.localStore, t, e.get(t.name));
 ...
 */ class sc {
    ...
    e) {
        ...
        this.mutatedKeys = _s(), this.Gu = gn(t), this.Qu = new Lu(this.Gu);
    }
    /**
     ...
     */    Wu(t, e) {
        const n = e ? e.zu : new Uu, s = e ? e.Qu : this.Qu;
        ...
        if (t.inorderTraversal(((t, e) => {
            const a = s.get(t), h = wn(this.query, e) ? e : null, l = !!a && this.mutatedKeys.has(a.key), f = !!h && (h.hasLocalMutations || 
 ...
 */ (t.type, e.type) || this.Gu(t.doc, e.doc))), this.Ju(n);
    ...
    Yu() {
        ...
        // updating many documents.
                const t = this.Ku;
        this.Ku = _s(), this.Qu.forEach((t => {
            this.Zu(t.key) && (this.Ku = this.Ku.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.Ku.has(t) || e.push(new nc(t));
        })), this.Ku.forEach((n => {
 ...
 */ class oc {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.sc = {}, this.ic = new ss((t => dn(t)), fn), 
        this.rc = new Map, 
        /**
         ...
         * active target.
         */
        this.uc = new Lt(at.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.cc = new Map, this.ac = new so, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.hc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.lc = new Map, this.fc = Nr.vn(), this.onlineState = "Unknown" /* Unknown */ , 
...
/** Stops listening to the query. */ async function ac(t, e) {
    ...
    if (i.length > 1) return n.rc.set(s.targetId, i.filter((t => !fn(t, e)))), void n.ic.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        if (n.isPrimaryClient) {
        // We need to remove the local query target first to allow us to verify
        // whether any other client is still interested in this target.
        n.sharedClientState.removeLocalQueryTarget(s.targetId);
        n.sharedClientState.isActiveQueryTarget(s.targetId) || await Co(n.localStore, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.sharedClientState.clearQueryState(s.targetId), du(n.remoteStore, s.targetId), 
            pc(n, s.targetId);
        })).catch(At);
    } else pc(n, s.targetId), await Co(n.localStore, s.targetId, 
 ...
 */ async function hc(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = B(t), s = st.now(), i = e.reduce(((t, e) => t.add(e.key)), _s());
            let r, o;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => {
                ...
                return n.Gi.getEntries(t, i).next((t => {
                    ...
                    const o = [];
                    for (const t of e) {
                        const e = Kn(t, r.get(t.key).overlayedDocument);
                        null != e && 
                        // NOTE: The base state should only be applied if there's some
                        // existing document to override, so use a Precondition of
                        // exists=true
                        o.push(new jn(t.key, e, De(e.value.mapValue), Fn.exists(!0)));
                    }
 ...
 */ async function dc(t, e, n) {
    ...
    if (r) {
        ...
        let t = new Lt(at.comparator);
        // TODO(b/217189216): This limbo document should ideally have a read time,
        // so that it is picked up by any read-time based scans. The backend,
        // however, does not send a read time for target removals.
                t = t.insert(r, Ce.newNoDocument(r, it.min()));
        const n = _s().add(r), i = new gs(it.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new Kt(tt), t, n);
        await lc(s, i), 
        ...
        s.uc = s.uc.remove(r), s.cc.delete(e), Ac(s);
    } else await Co(s.localStore, e, 
    /* keepPersistedTargetData */ !1).then((() => pc(s, e, n))).catch(At);
}
 ...
 */ async function mc(t, e) {
    const n = B(t);
    yu(n.remoteStore) || x("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
function Ic(t, e) {
    ...
    const n = t.uc.get(e);
    null !== n && (du(t.remoteStore, n), t.uc = t.uc.remove(e), t.cc.delete(n), Ac(t));
}

function Tc(t, e, n) {
    for (const s of n) if (s instanceof ec) t.ac.addReference(s.key, e), Ec(t, s); else if (s instanceof nc) {
 ...
 */ function Ac(t) {
    for (;t.oc.size > 0 && t.uc.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.cc.set(s, new rc(n)), t.uc = t.uc.insert(n, s), fu(t.remoteStore, new Bi(hn(sn(n.path)), s, 2 /* LimboResolution */ , Mt.at));
    }
}
...
async function bc(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        function(t, e) {
            t.lc.forEach((t => {
                t.forEach((t => {
                    t.reject(new U(L.CANCELLED, e));
                }));
            })), t.lc.clear();
        }(n, "'waitForPendingWrites' promise is rejected due to a user change."), 
        // TODO(b/114226417): Consider calling this only in the primary tab.
        n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await Rc(n, t.ji);
    }
}

function Pc(t, e) {
    const n = B(t), s = n.cc.get(e);
    if (s && s.nc) return _s().add(s.key);
    {
        let t = _s();
        const s = n.rc.get(e);
        if (!s) return t;
 ...
 */ async function vc(t, e) {
    ...
    return n.isPrimaryClient && Tc(n, e.targetId, i.Xu), i;
}
...
async function Vc(t, e) {
    const n = B(t);
    return ko(n.localStore, e).then((t => Rc(n, t)));
}
...
async function Dc(t, e) {
    ...
    if (Mc(n), Fc(n), !0 === e && !0 !== n.dc) {
        ...
        n.dc = !0, await Ou(n.remoteStore, !0);
        ...
        function(t) {
            ...
            e.cc.forEach(((t, n) => {
                du(e.remoteStore, n);
            })), e.ac.fs(), e.cc = new Map, e.uc = new Lt(at.comparator);
        }
        /**
 ...
 */
        // PORTING NOTE: Multi-Tab only.
        (n), n.dc = !1, await Ou(n.remoteStore, !1);
    }
}
...
async function Cc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await Do(s.localStore, hn(n[0]));
            for (const t of n) {
                const e = s.ic.get(t), n = await vc(s, e);
...
// PORTING NOTE: Multi-Tab only.
function xc(t) {
    return nn(t.path, t.collectionGroup, t.orderBy, t.filters, t.limit, "F" /* First */ , t.startAt, t.endAt);
}
 ...
 */ (t.localStore, s)) return await e.close(), n._completeWith(function(t) {
            ...
            const i = new Zu(s, t.localStore, e.It);
            let r = await e.mc();
            for (;r; ) {
...
class Bc {
    ...
    async initialize(t) {
        this.It = eu(t.databaseInfo.databaseId), this.sharedClientState = this.gc(t), this.persistence = this.yc(t), 
    ...
    Ic(t) {
        return Ao(this.persistence, new To, t.initialUser, this.It);
    }
    yc(t) {
        return new ao(lo.Bs, this.It);
    }
    gc(t) {
        return new Wo;
    }
 ...
 */ class Lc extends Bc {
    ...
    async initialize(t) {
        ...
        await Fc(this.Ac.syncEngine), await bu(this.Ac.remoteStore), 
    ...
    Tc(t, e) {
        ...
        return new Lr(n, t.asyncQueue, e);
    }
    Ec(t, e) {
    ...
    yc(t) {
        const e = po(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? br.withCacheSize(this.cacheSizeBytes) : br.DEFAULT;
        return new mo(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Zo(), tu(), this.It, this.sharedClientState, !!this.forceOwnership);
    }
    gc(t) {
        return new Wo;
    }
 ...
 */ class Uc extends Lc {
    ...
    async initialize(t) {
        ...
        this.sharedClientState instanceof jo && (this.sharedClientState.syncEngine = {
            Fr: Sc.bind(null, e),
            $r: kc.bind(null, e),
            Br: Oc.bind(null, e),
            vi: Nc.bind(null, e),
        ...
        await this.persistence.li((async t => {
            await Dc(this.Ac.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start() : t || this.gcScheduler.stop()), 
    ...
    gc(t) {
        const e = Zo();
        if (!jo.C(e)) throw new U(L.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = po(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new jo(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }
}
 ...
 */ class qc {
    ...
    createDatastore(t) {
        const e = eu(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Xo(s));
        var s;
        /** Return the Platform-specific connectivity monitor. */        return function(t, e, n, s) {
            return new ou(t, e, n, s);
        }(t.authCredentials, t.appCheckCredentials, n, e);
    }
    createRemoteStore(t) {
        return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => fc(this.syncEngine, t, 0 /* RemoteStore */), 
        r = Ho.C() ? new Ho : new zo, new au(e, n, s, i, r);
        var e, n, s, i, r;
 ...
 * limitations under the License.
 */ function Kc(t, e, n) {
    if (!n) throw new U(L.INVALID_ARGUMENT, `Function ${t}() cannot be called with an empty ${e}.`);
}
 ...
 * @internal
 */ function Gc(t, e, n, s) {
    if (!0 === e && !0 === s) throw new U(L.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
}
 ...
 */ function Qc(t) {
    if (!at.isDocumentKey(t)) throw new U(L.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function jc(t) {
    if (at.isDocumentKey(t)) throw new U(L.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new U(L.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        {
            const n = Wc(t);
            throw new U(L.INVALID_ARGUMENT, `Expected type '${e.name}', but it was: ${n}`);
        }
    }
    return t;
}
...
function Hc(t, e) {
    if (e <= 0) throw new U(L.INVALID_ARGUMENT, `Function ${t}() requires a positive number, but it was: ${e}.`);
}
...
class Yc {
    constructor(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new U(L.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = true;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new U(L.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
 ...
 */ class Xc {
     ...
     * instance.
     */    get app() {
        if (!this._app) throw new U(L.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this._app;
    }
    get _initialized() {
    ...
    _setSettings(t) {
        if (this._settingsFrozen) throw new U(L.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new Yc(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new U(L.INVALID_ARGUMENT, "makeAuthCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
    }
    _getSettings() {
 ...
 */
        return function(t) {
            const e = Jc.get(t);
            e && (x("ComponentProvider", "Removing Datastore"), Jc.delete(t), e.terminate());
 ...
 */ function Zc(t, e, n, s = {}) {
    var i;
    const r = (t = zc(t, Xc))._getSettings();
    ...
    t._setSettings(Object.assign(Object.assign({}, r), {
        ...
        if ("string" == typeof s.mockUserToken) e = s.mockUserToken, n = v.MOCK_USER; else {
            ...
            if (!r) throw new U(L.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            n = new v(r);
        }
 ...
 */ class na extends ea {
    ...
    withConverter(t) {
        return new na(this.firestore, t, this._path);
    }
}

function sa(t, e, ...n) {
    if (t = _(t), Kc("collection", "path", e), t instanceof Xc) {
        const s = ot.fromString(e, ...n);
        return jc(s), new na(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof ta || t instanceof na)) throw new U(L.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(ot.fromString(e, ...n));
        return jc(s), new na(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function ia(t, e) {
    if (t = zc(t, Xc), Kc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new U(L.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new ea(t, 
    /* converter= */ null, 
    /**
...
function ra(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = Z.R()), Kc("doc", "path", e), t instanceof Xc) {
        const s = ot.fromString(e, ...n);
        return Qc(s), new ta(t, 
        /* converter= */ null, new at(s));
    }
    {
        if (!(t instanceof ta || t instanceof na)) throw new U(L.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(ot.fromString(e, ...n));
        return Qc(s), new ta(t.firestore, t instanceof na ? t.converter : null, new at(s));
    }
}
 ...
 * Firestore database.
 */ function oa(t, e) {
    return t = _(t), e = _(e), (t instanceof ta || t instanceof na) && (e instanceof ta || e instanceof na) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function ua(t, e) {
    return t = _(t), e = _(e), t instanceof ea && e instanceof ea && (t.firestore === e.firestore && fn(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class da {
    ...
    run() {
        return uu(this.datastore, this.query._query).then((t => {
            F(void 0 !== t[0]);
            const e = Object.entries(t[0]).filter((([t, e]) => "count_alias" === t)).map((([t, e]) => this.userDataWriter.convertValue(e)))[0];
            return F("number" == typeof e), Promise.resolve(new fa(this.query, {
                count: e
            }));
        }));
    }
 ...
 */ class _a {
    ...
    async lookup(t) {
        if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new U(L.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = B(t), s = Bs(n.It) + "/documents", i = {
                documents: e.map((t => Os(n.It, t)))
    ...
    delete(t) {
        this.write(new Jn(t, this.precondition(t))), this.writtenDocs.add(t.toString());
    }
    async commit() {
        ...
        t.forEach(((t, e) => {
            ...
            this.mutations.push(new Yn(n, this.precondition(n)));
        })), await async function(t, e) {
            const n = B(t), s = Bs(n.It) + "/documents", i = {
    ...
    recordVersion(t) {
        ...
        if (n) {
            ...
            throw new U(L.ABORTED, "Document version changed between two reads.");
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(it.min()) ? Fn.exists(!1) : Fn.updateTime(e) : Fn.none();
    }
    /**
     ...
     */    preconditionForUpdate(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new U(L.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
 ...
 */ class wa {
    ...
    Mc(t) {
        try {
            ...
            return !re(e) && e.catch && e.then ? e : (this.deferred.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
class ma {
     ...
     */    verifyNotTerminated() {
        if (this.asyncQueue.isShuttingDown) throw new U(L.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    terminate() {
...
async function ga(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await Ro(e.localStore, t), s = t);
    })), 
...
/** Enables the network connection and re-enqueues all pending operations. */ function va(t) {
 ...
 */ function Sa(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            s.isFoundDocument() ? n.resolve(s) : s.isNoDocument() ? n.resolve(null) : n.reject(new U(L.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
        } catch (t) {
...
function Ca(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            /* usePreviousResults= */ !0), i = new sc(e, s.Hi), r = i.Wu(s.documents), o = i.applyChanges(r, 
            /* updateLimboDocuments= */ !1);
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new aa({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => ju(t, o))), n.fromCache && "server" === s.source ? i.reject(new U(L.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Ju(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function ka(t, e, n, s) {
    const i = function(t, e) {
        ...
        return function(t, e) {
            ...
            if (t instanceof Uint8Array) return ca(t, e);
            if (t instanceof ArrayBuffer) return ca(new Uint8Array(t), e);
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = $u.createAndSchedule(this, t, e, n, (t => this.Yc(t)));
...
class La extends Xc {
    ...
    _terminate() {
        ...
        Ga(this), this._firestoreClient.terminate();
    }
}
 ...
 */ function Ua(t, e, n) {
    ...
    if (s.isInitialized(n)) {
        ...
        if (w(i, e)) return t;
        throw new U(L.FAILED_PRECONDITION, "initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.");
    }
    if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new U(L.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return s.initialize({
        options: e,
 ...
 * @internal
 */ function Ka(t) {
    return t._firestoreClient || Ga(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function Ga(t) {
    var e;
    const n = t._freezeSettings(), s = function(t, e, n, s) {
        return new se(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams);
    }
    /**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ function Qa(t, e) {
    eh(t = zc(t, La));
    const n = Ka(t), s = t._freezeSettings(), i = new qc;
    return Wa(n, i, new Lc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function ja(t) {
    eh(t = zc(t, La));
    const e = Ka(t), n = t._freezeSettings(), s = new qc;
...
function za(t) {
    if (t._initialized && !t._terminated) throw new U(L.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    const e = new q;
 ...
 * @param onRemove - A function to invoke for every element that is part of
 * `before` but not `after`.
 */ (po(t._databaseId, t._persistenceKey)), e.resolve();
        } catch (t) {
            e.reject(t);
        }
    })), e.promise;
 ...
 */ function Ha(t) {
    return function(t) {
        const e = new q;
        return t.asyncQueue.enqueueAndForget((async () => mc(await Ra(t), e))), e.promise;
    }(Ka(t = zc(t, La)));
}
 ...
 */ function th(t, e) {
    return Oa(Ka(t = zc(t, La)), e).then((e => e ? new ea(t, null, e.query) : null));
}

function eh(t) {
    if (t._initialized || t._terminated) throw new U(L.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
...
class nh {
     ...
     */    static fromBase64String(t) {
        try {
            return new nh(Ht.fromBase64String(t));
        } catch (t) {
            throw new U(L.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
        }
    }
    /**
     ...
     */    static fromUint8Array(t) {
        return new nh(Ht.fromUint8Array(t));
    }
    /**
 ...
 */ class sh {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new U(L.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ class oh {
     ...
     */
    constructor(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new U(L.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new U(L.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
/** The result of parsing document data (e.g. for a setData call). */ class ch {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new jn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Qn(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class ah {
    constructor(t, 
    ...
    toMutation(t, e) {
        return new jn(t, this.data, this.fieldMask, e, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class lh {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    ia(t) {
        return new lh(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.It, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    ra(t) {
        var e;
    ...
    ha(t) {
        return Ch(t, this.settings.methodName, this.settings.la || !1, this.path, this.settings.fa);
    }
    ...
    ua(t) {
        ...
        if (hh(this.sa) && uh.test(t)) throw this.ha('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class fh {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.It = n || eu(t);
    }
...
function dh(t) {
    ...
    return new fh(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function _h(t, e, n, s, i, r = {}) {
    ...
    if (r.merge) c = new jt(o.fieldMask), a = o.fieldTransforms; else if (r.mergeFields) {
        ...
        for (const s of r.mergeFields) {
            const i = Vh(e, s, n);
            if (!o.contains(i)) throw new U(L.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
            xh(t, i) || t.push(i);
        }
        c = new jt(t), a = o.fieldTransforms.filter((t => c.covers(t.field)));
    } else c = null, a = o.fieldTransforms;
    return new ch(new Se(u), c, a);
}
...
class yh extends rh {
    ...
    _toFieldTransform(t) {
        const e = mh(this, t, 
        /*array=*/ !0), n = this._a.map((t => Rh(t, e))), s = new vn(n);
        return new kn(t.path, s);
    }
    isEqual(t) {
...
class ph extends rh {
    ...
    _toFieldTransform(t) {
        const e = mh(this, t, 
        /*array=*/ !0), n = this._a.map((t => Rh(t, e))), s = new Sn(n);
        return new kn(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Ih extends rh {
    ...
    _toFieldTransform(t) {
        const e = new Cn(t.It, Tn(t.It, this.wa));
        return new kn(t.path, e);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
...
/** Parse update data from an update() call. */ function Th(t, e, n, s) {
    ...
    const u = new jt(r);
    return new ah(o, u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Eh(t, e, n, s, i, r) {
    const o = t.da(1 /* Update */ , e, n), u = [ Vh(e, s, n) ], c = [ i ];
    if (r.length % 2 != 0) throw new U(L.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
    ...
    const l = new jt(a);
    return new ah(h, l, o.fieldTransforms);
}
 ...
 */ function Ah(t, e, n, s = !1) {
    return Rh(n, t.da(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Rh(t, e) {
    ...
    // from firestore-exp.
    t = _(t))) return vh("Unsupported field value:", e, t), bh(t, e);
    if (t instanceof rh) 
 ...
 */
    return function(t, e) {
        ...
        if (!hh(e.sa)) throw e.ha(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof oh) return {
            geoPointValue: {
                latitude: t.latitude,
                longitude: t.longitude
            }
        };
        if (t instanceof nh) return {
            bytesValue: Ds(e.It, t._byteString)
        };
        if (t instanceof ta) {
            ...
            return {
                referenceValue: Ns(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.ha(`Unsupported field value: ${Wc(t)}`);
    }
    /**
...
function bh(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : $t(t, ((t, s) => {
        const i = Rh(s, e.ra(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function Ph(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof st || t instanceof oh || t instanceof nh || t instanceof ta || t instanceof rh);
}
 ...
 */ function Vh(t, e, n) {
    ...
    // FieldPath.
    e = _(e)) instanceof sh) return e._internalPath;
    if ("string" == typeof e) return Dh(t, e);
 ...
 * evaluated.
 */ function Dh(t, e, n) {
    if (e.search(Sh) >= 0) throw Ch(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new sh(...e.split("."))._internalPath;
    } catch (s) {
        throw Ch(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
...
function Ch(t, e, n, s, i) {
    ...
    c += ")"), new U(L.INVALID_ARGUMENT, u + t + c);
}
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new kh(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
 ...
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Oh(t, e) {
    return "string" == typeof e ? Dh(t, e) : e instanceof sh ? e._internalPath : e._delegate._internalPath;
}
 ...
 * limitations under the License.
 */ function Mh(t) {
    if ("L" /* Last */ === t.limitType && 0 === t.explicitOrderBy.length) throw new U(L.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class Bh extends Fh {
    ...
    _apply(t) {
        const e = dh(t.firestore), n = function(t, e, n, s, i, r, o) {
            let u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r) throw new U(L.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on documentId().`);
                if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                    tl(o, r);
                    const e = [];
                    for (const n of o) e.push(Zh(s, t, n));
                    u = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || tl(o, r), 
            u = Ah(n, e, o, 
            ...
            return function(t, e) {
                if (e.dt()) {
                    const n = un(t);
                    if (null !== n && !n.isEqual(e.field)) throw new U(L.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                    const s = on(t);
                    null !== s && el(t, e.field, s);
                }
                const n = function(t, e) {
 ...
 */
                ...
                throw n === e.op ? new U(L.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new U(L.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
            }(t, c), c;
        }(t._query, "where", e, t.firestore._databaseId, this.ma, this.ga, this.ya);
        return new ea(t.firestore, t.converter, function(t, e) {
            const n = t.filters.concat([ e ]);
            return new en(t.path, t.collectionGroup, t.explicitOrderBy.slice(), n, t.limit, t.limitType, t.startAt, t.endAt);
        }(t._query, n));
    }
}
...
class Uh extends Fh {
    ...
    _apply(t) {
        const e = function(t, e, n) {
            if (null !== t.startAt) throw new U(L.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new U(L.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            const s = new Ye(e, n);
            return function(t, e) {
                if (null === on(t)) {
                    // This is the first order by. It must match any inequality.
                    const n = un(t);
                    null !== n && el(t, n, e.field);
                }
            }(t, s), s;
        }
        /**
...
class Kh extends Fh {
    ...
    _apply(t) {
        return new ea(t.firestore, t.converter, ln(t._query, this.Ia, this.Ta));
    }
}
 ...
 * @returns The created {@link Query}.
 */ function Gh(t) {
    return Hc("limit", t), new Kh("limit", t, "F" /* First */);
}
 ...
 * @returns The created {@link Query}.
 */ function Qh(t) {
    return Hc("limitToLast", t), new Kh("limitToLast", t, "L" /* Last */);
}
...
class jh extends Fh {
    ...
    _apply(t) {
        const e = Xh(t, this.type, this.Ea, this.Aa);
        return new ea(t.firestore, t.converter, function(t, e) {
            return new en(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, e, t.endAt);
        }(t._query, e));
    }
}

function Wh(...t) {
    return new jh("startAt", t, 
    /*inclusive=*/ !0);
}

function zh(...t) {
    return new jh("startAfter", t, 
    /*inclusive=*/ !1);
}
...
class Hh extends Fh {
    ...
    _apply(t) {
        const e = Xh(t, this.type, this.Ea, this.Aa);
        return new ea(t.firestore, t.converter, function(t, e) {
            return new en(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, e);
        }(t._query, e));
    }
}

function Jh(...t) {
    return new Hh("endBefore", t, 
    /*inclusive=*/ !1);
}

function Yh(...t) {
    return new Hh("endAt", t, /*inclusive=*/ !0);
}

/** Helper function to create a bound from a document or fields */ function Xh(t, e, n, s) {
    if (n[0] = _(n[0]), n[0] instanceof Nh) return function(t, e, n, s, i) {
        if (!s) throw new U(L.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n}().`);
        const r = [];
        ...
        // results.
                for (const n of an(t)) if (n.field.isKeyField()) r.push(ge(e, s.key)); else {
            const t = s.data.field(n.field);
            if (te(t)) throw new U(L.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = n.field.canonicalString();
                throw new U(L.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
            }
            r.push(t);
        }
        return new Je(r, i);
 ...
 */ (t._query, t.firestore._databaseId, e, n[0]._document, s);
    {
        const i = dh(t.firestore);
        return function(t, e, n, s, i, r) {
            // Use explicit order by's because it has to match the query the user made
            const o = t.explicitOrderBy;
            if (i.length > o.length) throw new U(L.INVALID_ARGUMENT, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const u = [];
            for (let r = 0; r < i.length; r++) {
                const c = i[r];
                if (o[r].field.isKeyField()) {
                    if ("string" != typeof c) throw new U(L.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof c}`);
                    if (!cn(t) && -1 !== c.indexOf("/")) throw new U(L.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${s}() must be a plain document ID, but '${c}' contains a slash.`);
                    const n = t.path.child(ot.fromString(c));
                    if (!at.isDocumentKey(n)) throw new U(L.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new at(n);
                    u.push(ge(e, i));
                } else {
                    const t = Ah(n, s, c);
...
function Zh(t, e, n) {
    if ("string" == typeof (n = _(n))) {
        if ("" === n) throw new U(L.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!cn(e) && -1 !== n.indexOf("/")) throw new U(L.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(ot.fromString(n));
        if (!at.isDocumentKey(s)) throw new U(L.INVALID_ARGUMENT, `Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return ge(t, new at(s));
    }
    if (n instanceof ta) return ge(t, n._key);
    throw new U(L.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Wc(n)}.`);
}
 ...
 * array requirements.
 */ function tl(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new U(L.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
    if (t.length > 10) throw new U(L.INVALID_ARGUMENT, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
}

function el(t, e, n) {
    if (!n.isEqual(e)) throw new U(L.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
 ...
 */ class nl {
    ...
    convertGeoPoint(t) {
        return new oh(Xt(t.latitude), Xt(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertDocumentKey(t, e) {
        ...
        F(oi(n));
        const s = new ie(n.get(1), n.get(3)), i = new at(n.popFirst(5));
        return s.isEqual(e) || 
 ...
 */ class cl {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new rl(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new ul(this._firestore, this._userDataWriter, n.key, n, new rl(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new U(L.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            ...
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new ul(t._firestore, t._userDataWriter, e.doc.key, e.doc, new rl(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 */ function ll(t) {
    t = zc(t, ta);
    const e = zc(t.firestore, La);
    return Da(Ka(e), t._key).then((n => bl(e, t, n)));
}
 ...
 */ function dl(t) {
    t = zc(t, ta);
    const e = zc(t.firestore, La), n = Ka(e), s = new fl(e);
    return Sa(n, t._key).then((n => new ol(e, s, t._key, n, new rl(null !== n && n.hasLocalMutations, 
 ...
 */ function wl(t) {
    t = zc(t, ea);
    const e = zc(t.firestore, La), n = Ka(e), s = new fl(e);
    return Mh(t._query), xa(n, t._query).then((n => new cl(e, s, t, n)));
}
 ...
 */ function ml(t) {
    t = zc(t, ea);
    const e = zc(t.firestore, La), n = Ka(e), s = new fl(e);
    return Ca(n, t._query).then((n => new cl(e, s, t, n)));
}
 ...
 */ function gl(t) {
    ...
    return xa(n, t._query, {
        source: "server"
    }).then((n => new cl(e, s, t, n)));
}

function yl(t, e, n) {
    t = zc(t, ta);
    const s = zc(t.firestore, La), i = sl(t.converter, e, n);
    return Rl(s, [ _h(dh(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Fn.none()) ]);
}

function pl(t, e, n, ...s) {
    t = zc(t, ta);
    const i = zc(t.firestore, La), r = dh(i);
    let o;
    o = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = _(e)) || e instanceof sh ? Eh(r, "updateDoc", t._key, e, n, s) : Th(r, "updateDoc", t._key, e);
    return Rl(i, [ o.toMutation(t._key, Fn.exists(!0)) ]);
}
 ...
 */ function Il(t) {
    return Rl(zc(t.firestore, La), [ new Jn(t._key, Fn.none()) ]);
}
 ...
 */ function Tl(t, e) {
    const n = zc(t.firestore, La), s = ra(t), i = sl(t.converter, e);
    return Rl(n, [ _h(dh(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Fn.exists(!1)) ]).then((() => s));
}
...
function El(t, ...e) {
    ...
    let c, a, h;
    if (t instanceof ta) a = zc(t.firestore, La), h = sn(t._key.path), c = {
        next: n => {
            e[o] && e[o](bl(a, t, n));
        },
        error: e[o + 1],
        ...
        const n = zc(t, ea);
        a = zc(n.firestore, La), h = n._query;
        const s = new fl(a);
        c = {
            next: t => {
                e[o] && e[o](new cl(a, s, n, t));
            },
            error: e[o + 1],
            complete: e[o + 2]
        }, Mh(t._query);
    ...
    return function(t, e, n, s) {
        const i = new aa(s), r = new Ju(e, i, n);
        return t.asyncQueue.enqueueAndForget((async () => Qu(await Pa(t), r))), () => {
            i.bc(), t.asyncQueue.enqueueAndForget((async () => ju(await Pa(t), r)));
        };
    }(Ka(a), h, u, c);
}

function Al(t, e) {
    return Na(Ka(t = zc(t, La)), Fa(e) ? e : {
        next: e
    });
}
 ...
 */ function Rl(t, e) {
    return function(t, e) {
        const n = new q;
        return t.asyncQueue.enqueueAndForget((async () => hc(await Ra(t), e, n))), n.promise;
    }(Ka(t), e);
}
 ...
 */ function bl(t, e, n) {
    ...
    return new ol(t, i, e._key, s, new rl(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 * otherwise.
 */ function Pl(t, e) {
    return ua(t.query, e.query) && w(t.data(), e.data());
}
 ...
 */ function vl(t) {
    ...
    return function(t, e, n) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => {
            try {
                if (yu(await Aa(t))) {
                    const i = await ba(t), r = new da(e, i, n).run();
                    s.resolve(r);
                } else s.reject(new U(L.UNAVAILABLE, "Failed to get count result because the client is offline."));
            } catch (t) {
                s.reject(t);
            }
        })), s.promise;
...
class Sl {
    ...
    constructor(t, e) {
        ...
        this._dataReader = dh(t);
    }
    set(t, e, n) {
        this._verifyNotCommitted();
        const s = Dl(t, this._firestore), i = sl(s.converter, e, n), r = _h(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
        return this._mutations.push(r.toMutation(s._key, Fn.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        const i = Dl(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return r = "string" == typeof (e = _(e)) || e instanceof sh ? Eh(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Th(this._dataReader, "WriteBatch.update", i._key, e), 
        this._mutations.push(r.toMutation(i._key, Fn.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const e = Dl(t, this._firestore);
        return this._mutations = this._mutations.concat(new Jn(e._key, Fn.none())), this;
    }
    /**
    ...
    _verifyNotCommitted() {
        if (this._committed) throw new U(L.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function Dl(t, e) {
    if ((t = _(t)).firestore !== e) throw new U(L.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
class Cl extends class {
    /** @hideconstructor */
    constructor(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = dh(t);
    }
    /**
     ...
     */    get(t) {
        const e = Dl(t, this._firestore), n = new il(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return M();
            const s = t[0];
            if (s.isFoundDocument()) return new Nh(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new Nh(this._firestore, n, e._key, null, e.converter);
            throw M();
        }));
    }
    set(t, e, n) {
        const s = Dl(t, this._firestore), i = sl(s.converter, e, n), r = _h(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = _(e)) || e instanceof sh ? Eh(this._dataReader, "Transaction.update", i._key, e, n, s) : Th(this._dataReader, "Transaction.update", i._key, e), 
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = Dl(t, this._firestore), n = new fl(this._firestore);
        return super.get(t).then((t => new ol(this._firestore, n, e._key, t._document, new rl(
        /* hasPendingWrites= */ !1, 
 ...
 */ function xl(t, e, n) {
    t = zc(t, La);
    const s = Object.assign(Object.assign({}, Vl), n);
    !function(t) {
        if (t.maxAttempts < 1) throw new U(L.INVALID_ARGUMENT, "Max attempts must be at least 1");
    }(s);
    return function(t, e, n) {
        const s = new q;
        return t.asyncQueue.enqueueAndForget((async () => {
 ...
 * writes.
 */ function $l(t) {
    return Ka(t = zc(t, La)), new Sl(t, (e => Rl(t, e)));
}
    ...
    const i = function(t) {
        const e = "string" == typeof t ? function(t) {
            ...
            try {
                ...
                throw new U(L.INVALID_ARGUMENT, "Failed to parse JSON: " + (null === (e = t) || void 0 === e ? void 0 : e.message));
            }
        }(t) : t, n = [];
        if (Array.isArray(e.indexes)) for (const t of e.indexes) {
            const e = Ll(t, "collectionGroup"), s = [];
            if (Array.isArray(t.fields)) for (const e of t.fields) {
                const t = Dh("setIndexConfiguration", Ll(e, "fieldPath"));
                "CONTAINS" === e.arrayConfig ? s.push(new _t(t, 2 /* CONTAINS */)) : "ASCENDING" === e.order ? s.push(new _t(t, 0 /* ASCENDING */)) : "DESCENDING" === e.order && s.push(new _t(t, 1 /* DESCENDING */));
            }
...
function Ll(t, e) {
    if ("string" != typeof t[e]) throw new U(L.INVALID_ARGUMENT, "Missing string value for: " + e);
    return t[e];
}
 ...
 */ !function(t, e = !0) {
    !function(t) {
        ...
        const i = t.getProvider("app").getImmediate(), r = new La(new j(t.getProvider("auth-internal")), new J(t.getProvider("app-check-internal")), function(t, e) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new U(L.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
            return new ie(t.options.projectId, e);
        }
        /**
 * @license
 * Copyright 2017 Google LLC
