    ...
    // update done
    {
      ...
      children: [
        ...
        },
        {
          ...
          // loader: ({ params }) =>
          //   fetch(` https://books-review-mocha.vercel.app/orders?UserId=${params.id}`),
        },
        {
          path: "/orderRow/:id",
          element: (
          ...
          loader: ({ params }) =>
            fetch(
              ` https://books-review-mocha.vercel.app/singleOrder/${params.id}`
            ),
        },
        {
          ...
          loader: ({ params }) =>
            fetch(
              ` https://books-review-mocha.vercel.app/services/${params.id}`
            ),
        },
        {
          ...
          loader: ({ params }) =>
            fetch(
              ` https://books-review-mocha.vercel.app/categoryEdit/${params.id}`
            ),
        },
        {
          // path: "/checkout/:id",
      ...
      children: [
        {
          ...
          loader: ({ params }) =>
            fetch(
              ` https://books-review-mocha.vercel.app/category/${params.id}`
            ),
        },
        {
          path: "/category",
