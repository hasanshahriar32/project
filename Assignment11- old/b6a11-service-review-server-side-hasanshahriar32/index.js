...
async function run() {
  try {
    const usersCollection = client.db("personalservice").collection("users");
    const postsCollection = client.db("personalservice").collection("posts");
    const serviceCollection = client
      .db("personalservice")
      .collection("services");
    const category = client.db("personalservice").collection("category");
