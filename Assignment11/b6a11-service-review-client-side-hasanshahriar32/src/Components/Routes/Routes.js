    ...
    // update done
    {
      ...
      children: [
        ...
        },
        {
          ...
          // loader: ({ params }) =>
          //   fetch(` https://paradox-pet.vercel.app/orders?UserId=${params.id}`),
        },
        {
          path: "/orderRow/:id",
          element: (
          ...
          loader: ({ params }) =>
            fetch(` https://paradox-pet.vercel.app/singleOrder/${params.id}`),
        },
        {
          ...
          loader: ({ params }) =>
            fetch(` https://paradox-pet.vercel.app/services/${params.id}`),
        },
        {
          ...
          loader: ({ params }) =>
            fetch(` https://paradox-pet.vercel.app/categoryEdit/${params.id}`),
        },
        {
          // path: "/checkout/:id",
          // element: (
      ...
      children: [
        {
          ...
          loader: ({ params }) =>
            fetch(` https://paradox-pet.vercel.app/category/${params.id}`),
        },
        {
          path: "/category",
          element: <Categories />,
