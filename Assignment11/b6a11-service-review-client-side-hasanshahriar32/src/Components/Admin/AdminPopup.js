            ...
            <ul class="space-y-2">
              <li>
                ...
                >
                  ...
                  <span class="inline-flex items-center justify-center w-12 h-3 p-3 ml-3 text-sm font-medium text-blue-600 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-200">
                    new
                  </span>
                </a>
              </li>
