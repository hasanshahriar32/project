...
const AllUser = () => {
  ...
  //   axios
  //     .get(
  //       " https://paradox-pet.vercel.app/users"
  //     )
  //     .then((res) => {
  //       setUsers(res.data);
  //     })
  ...
  const { data: users = [], refetch } = useQuery({
    queryKey: ["users"],
    queryFn: () =>
      axios.get("https://paradox-pet.vercel.app/users").then((res) => res.data),
  });

  const handleRemoveUser = (id) => {
    fetch(`https://paradox-pet.vercel.app/admin/deleteUser/${id}`, {
      method: "DELETE",
      headers: {
  ...
  const handleMakeAdmin = (id) => {
    ...
    fetch(`https://paradox-pet.vercel.app/users/admin/${id}`, {
      method: "PUT",
      headers: {
        authorization: `bearer ${localStorage.getItem("token")}`,
      },
