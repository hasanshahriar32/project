  ...
  return (
    <div>
          ...
          <div class="grid mb-8 lg:mb-12 lg:grid-cols-2">
            <figure class="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                ...
                <p class="my-4">
                  "I recently got my hands on Paradox Services Pro, and holy
                  crap, I'm speechless with how easy this was to integrate
                  within my application. Most templates are a pain, code is
                  scattered, and near impossible to theme.
                </p>
                <p class="my-4">
                  Paradox Services has code in one place and I'm not joking when
                  I say it took me a matter of minutes to copy the code,
            ...
            <figure class="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                ...
                <p class="my-4">
                  " Paradox Services provides a robust set of design tokens and
            ...
            <figure class="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 lg:border-b-0 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                ...
                <p class="my-4">
                  ...
                  with Paradox Services my mind was 🤯.
                </p>
                <p class="my-4">
      ...
      {/* <iframe
        ...
        title="Issb-complete Notes_ Issb Complete Procedure"
        src="https://www.scribd.com/embeds/374246107/content?start_page=1&view_mode=slideshow&access_key=key-lzOgWcr1RTGLQzFuqPbp"
        tabindex="0"
      ...
      {/* <p style="   margin: 12px auto 6px auto;   font-family: Helvetica,Arial,Sans-serif;   font-style: normal;   font-variant: normal;   font-weight: normal;   font-size: 14px;   line-height: normal;   font-size-adjust: none;   font-stretch: normal;   -x-system-font: none;   display: block;">
        <a
          title="View Issb-complete Notes_ Issb Complete Procedure on Scribd"
          href="https://www.scribd.com/document/406365961/Issb-complete-Notes-Issb-Complete-Procedure#from_embed"
          style="text-decoration: underline;"
        >
          Issb-complete Notes_ Issb C...
        </a>{" "}
        by{" "}
        <a
          title="View Bilal's profile on Scribd"
          href="https://www.scribd.com/user/444536052/Bilal#from_embed"
          style="text-decoration: underline;"
        >
          Bilal
        </a>
