...
async function run() {
  try {
    const usersCollection = client.db("petService").collection("users");
    const postsCollection = client.db("petService").collection("posts");
    const serviceCollection = client.db("petService").collection("services");
    const category = client.db("petService").collection("category");
    ...
    app.get("/categoryPost/:id", async (req, res) => {
      const id = req.params.id;
      const query = { categoryId: id };
      console.log(query);
    ...
    app.delete("/categoryPost/:id", async (req, res) => {
      const id = req.params.id;
