...
const Register = () => {
  ...
  return (
    <div className="flex text-base-content flex-wrap  justify-center items-center m-5">
      <div
      ...
      <div className="shadow-lg text-base-content flex gap-2  justify-center items-center flex-col border-dotted bg-base-200 w-80 m-5 p-5 rounded">
        <h1 className="text-center text-3xl m-3 mb-6">Register!</h1>
        <form
          onSubmit={handleSignUp}
          className=" gap-3 text-base-content flex justify-center items-center flex-col"
        >
          <div>
            <div className="mb-2 ">
              <Label
