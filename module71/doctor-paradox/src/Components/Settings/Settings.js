    ...
    <div>
      ...
      <section className="grid justify-center grid-cols-4">
        <aside
          ...
          data-aos="fade-right"
          className=" top-0 hidden md:block col-span-1 left-0  h-full"
          aria-label="Sidenav"
        >
          <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <ul class="space-y-2">
              <li>
                <a
                  href="#"
                  class="flex active items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                >
                  <svg
                    aria-hidden="true"
                  ...
                  <span class="ml-3 active">User Control</span>
                </a>
              </li>
              <li>
                <button
          ...
          <div class="hidden sticky justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20">
            <a
              href="#"
